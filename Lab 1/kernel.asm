...
8010005b:	e8 50 43 00 00       	call   801043b0 <initlock>
  bcache.head.next = &bcache.head;
...
8010009b:	80 
8010009c:	e8 df 41 00 00       	call   80104280 <initsleeplock>
...
801000e3:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000e6:	e8 35 44 00 00       	call   80104520 <acquire>
...
80100161:	e8 2a 44 00 00       	call   80104590 <release>
      acquiresleep(&b->lock);
80100166:	8d 43 0c             	lea    0xc(%ebx),%eax
80100169:	89 04 24             	mov    %eax,(%esp)
8010016c:	e8 4f 41 00 00       	call   801042c0 <acquiresleep>
  struct buf *b;
...
801001b0:	e8 ab 41 00 00       	call   80104360 <holdingsleep>
...
801001f1:	e8 6a 41 00 00       	call   80104360 <holdingsleep>
...
801001fd:	e8 1e 41 00 00       	call   80104320 <releasesleep>

  acquire(&bcache.lock);
80100202:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100209:	e8 12 43 00 00       	call   80104520 <acquire>
  b->refcnt--;
  if (b->refcnt == 0) {
...
8010024f:	5d                   	pop    %ebp
  release(&bcache.lock);
80100250:	e9 3b 43 00 00       	jmp    80104590 <release>
    panic("brelse");
...
8010028e:	e8 8d 42 00 00       	call   80104520 <acquire>
  while(n > 0){
...
80100311:	e8 7a 42 00 00       	call   80104590 <release>
  ilock(ip);
...
8010032f:	e8 5c 42 00 00       	call   80104590 <release>
        ilock(ip);
...
801003af:	e8 1c 40 00 00       	call   801043d0 <getcallerpcs>
...
801004fc:	e8 7f 41 00 00       	call   80104680 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100518:	00 
80100519:	e8 c2 40 00 00       	call   801045e0 <memset>
...
8010060e:	e8 0d 3f 00 00       	call   80104520 <acquire>
...
80100636:	e8 55 3f 00 00       	call   80104590 <release>
  ilock(ip);
...
801006f3:	e8 98 3e 00 00       	call   80104590 <release>
}
...
80100797:	e8 84 3d 00 00       	call   80104520 <acquire>
...
801007c5:	e8 56 3d 00 00       	call   80104520 <acquire>
...
80100827:	e8 64 3d 00 00       	call   80104590 <release>
  if(doprocdump) {
...
801008ad:	a3 a4 ff 10 80       	mov    %eax,0x8010ffa4
          wakeup(&input.r);
801008b2:	e8 19 38 00 00       	call   801040d0 <wakeup>
...
80100927:	e9 84 38 00 00       	jmp    801041b0 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100965:	e8 46 3a 00 00       	call   801043b0 <initlock>
...
80100c01:	e8 fa 3b 00 00       	call   80104800 <strlen>
...
80100c12:	e8 e9 3b 00 00       	call   80104800 <strlen>
...
80100cf1:	e8 ca 3a 00 00       	call   801047c0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d65:	e8 46 36 00 00       	call   801043b0 <initlock>
}
80100d6a:	c9                   	leave  
80100d6b:	c3                   	ret    
...
80100d83:	e8 98 37 00 00       	call   80104520 <acquire>
...
80100da9:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100db0:	e8 db 37 00 00       	call   80104590 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dc7:	e8 c4 37 00 00       	call   80104590 <release>
}
...
80100df1:	e8 2a 37 00 00       	call   80104520 <acquire>
  if(f->ref < 1)
...
80100e0a:	e8 81 37 00 00       	call   80104590 <release>
  return f;
}
...
80100e43:	e8 d8 36 00 00       	call   80104520 <acquire>
  if(f->ref < 1)
...
80100e6a:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e6b:	e9 20 37 00 00       	jmp    80104590 <release>
  ff = *f;
...
80100e8c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e8f:	e8 fc 36 00 00       	call   80104590 <release>
  if(ff.type == FD_PIPE)
...
80101278:	e8 63 33 00 00       	call   801045e0 <memset>
  log_write(bp);
...
801012b9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
801012bc:	e8 5f 32 00 00       	call   80104520 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801012f6:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012f9:	e8 92 32 00 00       	call   80104590 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
8010133e:	e8 4d 32 00 00       	call   80104590 <release>
}
...
80101452:	e8 29 32 00 00       	call   80104680 <memmove>
  brelse(bp);
...
8010148b:	e8 20 2f 00 00       	call   801043b0 <initlock>
...
801014a0:	80 
801014a1:	e8 da 2d 00 00       	call   80104280 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015a9:	e8 32 30 00 00       	call   801045e0 <memset>
      dip->type = type;
...
8010165f:	00 
80101660:	e8 1b 30 00 00       	call   80104680 <memmove>
  log_write(bp);
...
80101691:	e8 8a 2e 00 00       	call   80104520 <acquire>
  ip->ref++;
80101696:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010169a:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016a1:	e8 ea 2e 00 00       	call   80104590 <release>
}
...
801016d4:	e8 e7 2b 00 00       	call   801042c0 <acquiresleep>
  if(ip->valid == 0){
...
8010174b:	e8 30 2f 00 00       	call   80104680 <memmove>
    brelse(bp);
...
801017a5:	e8 b6 2b 00 00       	call   80104360 <holdingsleep>
...
801017bd:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017be:	e9 5d 2b 00 00       	jmp    80104320 <releasesleep>
    panic("iunlock");
...
801017e2:	e8 d9 2a 00 00       	call   801042c0 <acquiresleep>
...
801017f8:	e8 23 2b 00 00       	call   80104320 <releasesleep>
  acquire(&icache.lock);
801017fd:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101804:	e8 17 2d 00 00       	call   80104520 <acquire>
  ip->ref--;
...
8010181a:	5d                   	pop    %ebp
  release(&icache.lock);
8010181b:	e9 70 2d 00 00       	jmp    80104590 <release>
    acquire(&icache.lock);
80101820:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101827:	e8 f4 2c 00 00       	call   80104520 <acquire>
    int r = ip->ref;
8010182c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010182f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101836:	e8 55 2d 00 00       	call   80104590 <release>
    if(r == 1){
...
80101a08:	e8 73 2c 00 00       	call   80104680 <memmove>
    brelse(bp);
...
80101b04:	e8 77 2b 00 00       	call   80104680 <memmove>
    log_write(bp);
...
80101bab:	e8 50 2b 00 00       	call   80104700 <strncmp>
}
80101bb0:	c9                   	leave  
80101bb1:	c3                   	ret    
...
80101c29:	e8 d2 2a 00 00       	call   80104700 <strncmp>
      continue;
...
80101ca8:	e8 73 28 00 00       	call   80104520 <acquire>
  ip->ref++;
80101cad:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cb1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cb8:	e8 d3 28 00 00       	call   80104590 <release>
...
80101d1b:	e8 60 29 00 00       	call   80104680 <memmove>
    path++;
...
80101da9:	e8 d2 28 00 00       	call   80104680 <memmove>
    name[len] = 0;
...
80101ea3:	e8 c8 28 00 00       	call   80104770 <strncpy>
  de.inum = inum;
...
80102015:	e8 96 23 00 00       	call   801043b0 <initlock>
...
80102090:	e8 8b 24 00 00       	call   80104520 <acquire>
...
801020bc:	e8 0f 20 00 00       	call   801040d0 <wakeup>
...
801020d6:	e8 b5 24 00 00       	call   80104590 <release>
...
80102130:	e8 2b 22 00 00       	call   80104360 <holdingsleep>
...
80102166:	e8 b5 23 00 00       	call   80104520 <acquire>
...
801021c5:	5d                   	pop    %ebp
  release(&idelock);
801021c6:	e9 c5 23 00 00       	jmp    80104590 <release>
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
...
8010232a:	e8 b1 22 00 00       	call   801045e0 <memset>
...
801023fa:	e8 b1 1f 00 00       	call   801043b0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024cd:	e8 be 20 00 00       	call   80104590 <release>
  return (char*)r;
}
...
801024e7:	e8 34 20 00 00       	call   80104520 <acquire>
...
8010289c:	e8 8f 1d 00 00       	call   80104630 <memcmp>
...
801029c7:	e8 b4 1c 00 00       	call   80104680 <memmove>
...
80102a8a:	e8 21 19 00 00       	call   801043b0 <initlock>
  readsb(dev, &sb);
...
80102b1d:	e8 fe 19 00 00       	call   80104520 <acquire>
...
80102b65:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b6a:	e8 21 1a 00 00       	call   80104590 <release>
      break;
    }
  }
}
...
80102b90:	e8 8b 19 00 00       	call   80104520 <acquire>
  log.outstanding -= 1;
...
80102bc8:	00 00 00 
  release(&log.lock);
80102bcb:	e8 c0 19 00 00       	call   80104590 <release>
  if (log.lh.n > 0) {
...
80102c2f:	e8 4c 1a 00 00       	call   80104680 <memmove>
...
80102ced:	e8 2e 18 00 00       	call   80104520 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d3e:	5d                   	pop    %ebp
  release(&log.lock);
80102d3f:	e9 4c 18 00 00       	jmp    80104590 <release>
...
80102e71:	e8 0a 18 00 00       	call   80104680 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102f4b:	e8 e0 16 00 00       	call   80104630 <memcmp>
...
80103006:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103009:	e8 22 16 00 00       	call   80104630 <memcmp>
...
801031e6:	80 
801031e7:	e8 c4 11 00 00       	call   801043b0 <initlock>
  (*f0)->type = FD_PIPE;
...
80103271:	e8 aa 12 00 00       	call   80104520 <acquire>
  if(writable){
...
8010328d:	e8 3e 0e 00 00       	call   801040d0 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032ae:	5d                   	pop    %ebp
    release(&p->lock);
801032af:	e9 dc 12 00 00       	jmp    80104590 <release>
...
8010334f:	e8 7c 0d 00 00       	call   801040d0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
80103382:	e8 09 12 00 00       	call   80104590 <release>
        return -1;
...
801033ca:	e8 01 0d 00 00       	call   801040d0 <wakeup>
  release(&p->lock);
801033cf:	89 1c 24             	mov    %ebx,(%esp)
801033d2:	e8 b9 11 00 00       	call   80104590 <release>
  return n;
...
801033f2:	e8 29 11 00 00       	call   80104520 <acquire>
...
8010344b:	e8 40 11 00 00       	call   80104590 <release>
...
801034a5:	e8 26 0c 00 00       	call   801040d0 <wakeup>
  release(&p->lock);
801034aa:	89 34 24             	mov    %esi,(%esp)
801034ad:	e8 de 10 00 00       	call   80104590 <release>
}
...
801034d3:	e8 48 10 00 00       	call   80104520 <acquire>
...
8010350e:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103511:	e8 7a 10 00 00       	call   80104590 <release>
...
8010352d:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 25 58 10 80 	movl   $0x80105825,0x14(%eax)
...
8010354a:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010354d:	e8 8e 10 00 00       	call   801045e0 <memset>
...
8010356f:	e8 1c 10 00 00       	call   80104590 <release>
}
...
8010359d:	e8 ee 0f 00 00       	call   80104590 <release>
...
801035f5:	e8 b6 0d 00 00       	call   801043b0 <initlock>
}
801035fa:	c9                   	leave  
801035fb:	c3                   	ret    
...
801036a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801036a7:	e8 84 0d 00 00       	call   80104430 <pushcli>
  c = mycpu();
801036ac:	e8 4f ff ff ff       	call   80103600 <mycpu>
  p = c->proc;
801036b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036b7:	e8 b4 0d 00 00       	call   80104470 <popcli>
}
...
80103727:	e8 b4 0e 00 00       	call   801045e0 <memset>
...
8010378e:	e8 2d 10 00 00       	call   801047c0 <safestrcpy>
  p->cwd = namei("/");
...
80103988:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
8010398d:	e8 8e 0b 00 00       	call   80104520 <acquire>
...
801039b2:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039b5:	e8 f6 2f 00 00       	call   801069b0 <switchuvm>
...
801039cb:	e8 4b 0e 00 00       	call   8010481b <swtch>
      switchkvm();
801039d0:	e8 bb 2f 00 00       	call   80106990 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801039ef:	e8 9c 0b 00 00       	call   80104590 <release>
  }
...
80103a14:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103a16:	e8 c5 0a 00 00       	call   801044e0 <holding>
...
80103a57:	e8 bf 0d 00 00       	call   8010481b <swtch>
  mycpu()->intena = intena;
...
80103a6e:	c7 04 24 d0 75 10 80 	movl   $0x801075d0,(%esp)
80103a75:	e8 e6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a7a:	c7 04 24 fc 75 10 80 	movl   $0x801075fc,(%esp)
80103a81:	e8 da c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a86:	c7 04 24 ee 75 10 80 	movl   $0x801075ee,(%esp)
80103a8d:	e8 ce c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103a92:	c7 04 24 e2 75 10 80 	movl   $0x801075e2,(%esp)
...
80103b03:	e8 18 0a 00 00       	call   80104520 <acquire>
...
80103b96:	e8 65 fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103b9b:	c7 04 24 1d 76 10 80 	movl   $0x8010761d,(%esp)
80103ba2:	e8 b9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103ba7:	c7 04 24 10 76 10 80 	movl   $0x80107610,(%esp)
...
80103bcf:	89 c3                	mov    %eax,%ebx
  curproc->status = status; //setting the status. 
...
80103c06:	75 e0                	jne    80103be8 <exitS+0x28>
  begin_op();
...
80103c2b:	e8 f0 08 00 00       	call   80104520 <acquire>
  wakeup1(curproc->parent);
80103c30:	8b 43 14             	mov    0x14(%ebx),%eax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c33:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103c38:	eb 11                	jmp    80103c4b <exitS+0x8b>
...
80103c49:	74 1d                	je     80103c68 <exitS+0xa8>
    if(p->state == SLEEPING && p->chan == chan)
80103c4b:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103c4f:	75 ef                	jne    80103c40 <exitS+0x80>
80103c51:	3b 42 20             	cmp    0x20(%edx),%eax
80103c54:	75 ea                	jne    80103c40 <exitS+0x80>
      p->state = RUNNABLE;
...
80103ced:	e8 2e 08 00 00       	call   80104520 <acquire>
...
80103d0a:	e8 81 08 00 00       	call   80104590 <release>
}
80103d0f:	c9                   	leave  
80103d10:	c3                   	ret    
...
80103d51:	e8 ca 07 00 00       	call   80104520 <acquire>
    release(lk);
80103d56:	89 34 24             	mov    %esi,(%esp)
80103d59:	e8 32 08 00 00       	call   80104590 <release>
  p->chan = chan;
...
80103d7b:	e8 10 08 00 00       	call   80104590 <release>
    acquire(lk);
...
80103d89:	5d                   	pop    %ebp
    acquire(lk);
80103d8a:	e9 91 07 00 00       	jmp    80104520 <acquire>
80103d8f:	90                   	nop
  p->chan = chan;
...
80103dae:	c7 04 24 2f 76 10 80 	movl   $0x8010762f,(%esp)
80103db5:	e8 a6 c5 ff ff       	call   80100360 <panic>
    panic("sleep");
80103dba:	c7 04 24 29 76 10 80 	movl   $0x80107629,(%esp)
...
80103de4:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103de6:	e8 35 07 00 00       	call   80104520 <acquire>
    havekids = 0;
...
80103e58:	e8 b3 2e 00 00       	call   80106d10 <freevm>
        release(&ptable.lock);
...
80103e99:	e8 f2 06 00 00       	call   80104590 <release>
}
...
80103eb9:	8b 7d 08             	mov    0x8(%ebp),%edi
  struct proc *curproc = myproc();
80103ebc:	e8 df f7 ff ff       	call   801036a0 <myproc>
  acquire(&ptable.lock);
80103ec1:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103ec8:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103eca:	e8 51 06 00 00       	call   80104520 <acquire>
    havekids = 0;
80103ecf:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ed1:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103ed6:	eb 0b                	jmp    80103ee3 <waitS+0x33>
80103ed8:	83 eb 80             	sub    $0xffffff80,%ebx
80103edb:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103ee1:	74 1d                	je     80103f00 <waitS+0x50>
      if(p->parent != curproc)
80103ee3:	39 73 14             	cmp    %esi,0x14(%ebx)
80103ee6:	75 f0                	jne    80103ed8 <waitS+0x28>
      if(p->state == ZOMBIE){
80103ee8:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103eec:	74 2f                	je     80103f1d <waitS+0x6d>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103efc:	75 e5                	jne    80103ee3 <waitS+0x33>
80103efe:	66 90                	xchg   %ax,%ax
    if(!havekids || curproc->killed){
80103f00:	85 c0                	test   %eax,%eax
80103f02:	74 78                	je     80103f7c <waitS+0xcc>
80103f04:	8b 46 24             	mov    0x24(%esi),%eax
80103f07:	85 c0                	test   %eax,%eax
80103f09:	75 71                	jne    80103f7c <waitS+0xcc>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
...
80103f1b:	eb b2                	jmp    80103ecf <waitS+0x1f>
        kfree(p->kstack);
...
80103f38:	e8 d3 2d 00 00       	call   80106d10 <freevm>
        release(&ptable.lock);
...
80103f5d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f64:	e8 27 06 00 00       	call   80104590 <release>
        if(status) //if not null
80103f69:	85 ff                	test   %edi,%edi
80103f6b:	74 28                	je     80103f95 <waitS+0xe5>
          *status = p->status; //pass back the status of terminated child.
80103f6d:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103f70:	89 07                	mov    %eax,(%edi)
}
80103f72:	83 c4 1c             	add    $0x1c,%esp
        return pid;
80103f75:	89 f0                	mov    %esi,%eax
}
80103f77:	5b                   	pop    %ebx
80103f78:	5e                   	pop    %esi
80103f79:	5f                   	pop    %edi
...
80103f83:	e8 08 06 00 00       	call   80104590 <release>
}
80103f88:	83 c4 1c             	add    $0x1c,%esp
      return -1;
80103f8b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80103f90:	5b                   	pop    %ebx
80103f91:	5e                   	pop    %esi
80103f92:	5f                   	pop    %edi
80103f93:	5d                   	pop    %ebp
80103f94:	c3                   	ret    
80103f95:	83 c4 1c             	add    $0x1c,%esp
        return pid;
...
80103fac:	8b 7d 10             	mov    0x10(%ebp),%edi
80103faf:	89 55 e0             	mov    %edx,-0x20(%ebp)
  struct proc *curproc = myproc();
80103fb2:	e8 e9 f6 ff ff       	call   801036a0 <myproc>
  acquire(&ptable.lock);
80103fb7:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103fbe:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  acquire(&ptable.lock);
80103fc1:	e8 5a 05 00 00       	call   80104520 <acquire>
80103fc6:	8b 55 e0             	mov    -0x20(%ebp),%edx
    havekids = 0;
80103fc9:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fcb:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103fd0:	eb 11                	jmp    80103fe3 <waitpid+0x43>
80103fd2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103fd8:	83 eb 80             	sub    $0xffffff80,%ebx
80103fdb:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103fe1:	74 26                	je     80104009 <waitpid+0x69>
      if(pid != p->pid)
80103fe3:	8b 73 10             	mov    0x10(%ebx),%esi
80103fe6:	39 d6                	cmp    %edx,%esi
80103fe8:	75 ee                	jne    80103fd8 <waitpid+0x38>
      if(p->state == ZOMBIE){
80103fea:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103fee:	74 4a                	je     8010403a <waitpid+0x9a>
      else if(options == 1) //CUZ WNOHANG was declared to 1
80103ff0:	83 ff 01             	cmp    $0x1,%edi
80103ff3:	0f 84 a3 00 00 00    	je     8010409c <waitpid+0xfc>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ff9:	83 eb 80             	sub    $0xffffff80,%ebx
      havekids = 1;
80103ffc:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104001:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80104007:	75 da                	jne    80103fe3 <waitpid+0x43>
    if(!havekids || curproc->killed){
80104009:	85 c0                	test   %eax,%eax
8010400b:	0f 84 a3 00 00 00    	je     801040b4 <waitpid+0x114>
80104011:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104014:	8b 40 24             	mov    0x24(%eax),%eax
80104017:	85 c0                	test   %eax,%eax
80104019:	0f 85 95 00 00 00    	jne    801040b4 <waitpid+0x114>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
8010401f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104022:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80104029:	80 
8010402a:	89 55 e0             	mov    %edx,-0x20(%ebp)
8010402d:	89 04 24             	mov    %eax,(%esp)
80104030:	e8 eb fc ff ff       	call   80103d20 <sleep>
  }
80104035:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104038:	eb 8f                	jmp    80103fc9 <waitpid+0x29>
        kfree(p->kstack);
8010403a:	8b 43 08             	mov    0x8(%ebx),%eax
8010403d:	89 04 24             	mov    %eax,(%esp)
80104040:	e8 ab e2 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80104045:	8b 43 04             	mov    0x4(%ebx),%eax
        p->kstack = 0;
80104048:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
8010404f:	89 04 24             	mov    %eax,(%esp)
80104052:	e8 b9 2c 00 00       	call   80106d10 <freevm>
        release(&ptable.lock);
...
80104077:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010407e:	e8 0d 05 00 00       	call   80104590 <release>
        if(status) //if not null
80104083:	8b 55 0c             	mov    0xc(%ebp),%edx
80104086:	85 d2                	test   %edx,%edx
80104088:	74 08                	je     80104092 <waitpid+0xf2>
          *status = p->status; //pass back the status of terminated child.
8010408a:	8b 43 7c             	mov    0x7c(%ebx),%eax
8010408d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104090:	89 01                	mov    %eax,(%ecx)
}
80104092:	83 c4 1c             	add    $0x1c,%esp
80104095:	89 f0                	mov    %esi,%eax
80104097:	5b                   	pop    %ebx
80104098:	5e                   	pop    %esi
80104099:	5f                   	pop    %edi
8010409a:	5d                   	pop    %ebp
8010409b:	c3                   	ret    
        release(&ptable.lock);
8010409c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        return 0;
801040a3:	31 f6                	xor    %esi,%esi
        release(&ptable.lock);
801040a5:	e8 e6 04 00 00       	call   80104590 <release>
}
...
801040b3:	c3                   	ret    
      release(&ptable.lock);
801040b4:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
      return -1;
801040bb:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801040c0:	e8 cb 04 00 00       	call   80104590 <release>
      return -1;
801040c5:	eb cb                	jmp    80104092 <waitpid+0xf2>
...
801040e1:	e8 3a 04 00 00       	call   80104520 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
801040f8:	74 1e                	je     80104118 <wakeup+0x48>
    if(p->state == SLEEPING && p->chan == chan)
...
8010410f:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80104114:	75 e4                	jne    801040fa <wakeup+0x2a>
80104116:	66 90                	xchg   %ax,%ax
  wakeup1(chan);
  release(&ptable.lock);
80104118:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
8010411f:	83 c4 14             	add    $0x14,%esp
80104122:	5b                   	pop    %ebx
80104123:	5d                   	pop    %ebp
  release(&ptable.lock);
80104124:	e9 67 04 00 00       	jmp    80104590 <release>
...
80104137:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010413a:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104141:	e8 da 03 00 00       	call   80104520 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104146:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
...
80104158:	74 36                	je     80104190 <kill+0x60>
    if(p->pid == pid){
...
80104163:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
8010416a:	74 14                	je     80104180 <kill+0x50>
        p->state = RUNNABLE;
      release(&ptable.lock);
8010416c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104173:	e8 18 04 00 00       	call   80104590 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104178:	83 c4 14             	add    $0x14,%esp
      return 0;
...
8010417f:	c3                   	ret    
        p->state = RUNNABLE;
80104180:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80104187:	eb e3                	jmp    8010416c <kill+0x3c>
80104189:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  release(&ptable.lock);
80104190:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104197:	e8 f4 03 00 00       	call   80104590 <release>
}
...
801041b6:	bb c0 2d 11 80       	mov    $0x80112dc0,%ebx
801041bb:	83 ec 4c             	sub    $0x4c,%esp
801041be:	8d 75 e8             	lea    -0x18(%ebp),%esi
801041c1:	eb 20                	jmp    801041e3 <procdump+0x33>
801041c3:	90                   	nop
801041c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
801041c8:	c7 04 24 c3 79 10 80 	movl   $0x801079c3,(%esp)
801041cf:	e8 7c c4 ff ff       	call   80100650 <cprintf>
801041d4:	83 eb 80             	sub    $0xffffff80,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041d7:	81 fb c0 4d 11 80    	cmp    $0x80114dc0,%ebx
801041dd:	0f 84 8d 00 00 00    	je     80104270 <procdump+0xc0>
    if(p->state == UNUSED)
801041e3:	8b 43 a0             	mov    -0x60(%ebx),%eax
801041e6:	85 c0                	test   %eax,%eax
801041e8:	74 ea                	je     801041d4 <procdump+0x24>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801041ea:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801041ed:	ba 40 76 10 80       	mov    $0x80107640,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801041f2:	77 11                	ja     80104205 <procdump+0x55>
801041f4:	8b 14 85 a0 76 10 80 	mov    -0x7fef8960(,%eax,4),%edx
      state = "???";
801041fb:	b8 40 76 10 80       	mov    $0x80107640,%eax
80104200:	85 d2                	test   %edx,%edx
80104202:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80104205:	8b 43 a4             	mov    -0x5c(%ebx),%eax
80104208:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010420c:	89 54 24 08          	mov    %edx,0x8(%esp)
80104210:	c7 04 24 44 76 10 80 	movl   $0x80107644,(%esp)
80104217:	89 44 24 04          	mov    %eax,0x4(%esp)
8010421b:	e8 30 c4 ff ff       	call   80100650 <cprintf>
    if(p->state == SLEEPING){
80104220:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
80104224:	75 a2                	jne    801041c8 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104226:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104229:	89 44 24 04          	mov    %eax,0x4(%esp)
8010422d:	8b 43 b0             	mov    -0x50(%ebx),%eax
80104230:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104233:	8b 40 0c             	mov    0xc(%eax),%eax
80104236:	83 c0 08             	add    $0x8,%eax
80104239:	89 04 24             	mov    %eax,(%esp)
8010423c:	e8 8f 01 00 00       	call   801043d0 <getcallerpcs>
...
8010424c:	0f 84 76 ff ff ff    	je     801041c8 <procdump+0x18>
        cprintf(" %p", pc[i]);
80104252:	89 54 24 04          	mov    %edx,0x4(%esp)
80104256:	83 c7 04             	add    $0x4,%edi
80104259:	c7 04 24 81 70 10 80 	movl   $0x80107081,(%esp)
80104260:	e8 eb c3 ff ff       	call   80100650 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104265:	39 f7                	cmp    %esi,%edi
80104267:	75 df                	jne    80104248 <procdump+0x98>
80104269:	e9 5a ff ff ff       	jmp    801041c8 <procdump+0x18>
8010426e:	66 90                	xchg   %ax,%ax
  }
}
80104270:	83 c4 4c             	add    $0x4c,%esp
80104273:	5b                   	pop    %ebx
80104274:	5e                   	pop    %esi
80104275:	5f                   	pop    %edi
80104276:	5d                   	pop    %ebp
...
8010428a:	c7 44 24 04 b8 76 10 	movl   $0x801076b8,0x4(%esp)
80104291:	80 
80104292:	8d 43 04             	lea    0x4(%ebx),%eax
80104295:	89 04 24             	mov    %eax,(%esp)
80104298:	e8 13 01 00 00       	call   801043b0 <initlock>
  lk->name = name;
8010429d:	8b 45 0c             	mov    0xc(%ebp),%eax
  lk->locked = 0;
801042a0:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
801042a6:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
801042ad:	89 43 38             	mov    %eax,0x38(%ebx)
}
...
801042d1:	e8 4a 02 00 00       	call   80104520 <acquire>
  while (lk->locked) {
801042d6:	8b 13                	mov    (%ebx),%edx
801042d8:	85 d2                	test   %edx,%edx
801042da:	74 16                	je     801042f2 <acquiresleep+0x32>
801042dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
801042e0:	89 74 24 04          	mov    %esi,0x4(%esp)
801042e4:	89 1c 24             	mov    %ebx,(%esp)
801042e7:	e8 34 fa ff ff       	call   80103d20 <sleep>
  while (lk->locked) {
801042ec:	8b 03                	mov    (%ebx),%eax
801042ee:	85 c0                	test   %eax,%eax
801042f0:	75 ee                	jne    801042e0 <acquiresleep+0x20>
  }
  lk->locked = 1;
801042f2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801042f8:	e8 a3 f3 ff ff       	call   801036a0 <myproc>
801042fd:	8b 40 10             	mov    0x10(%eax),%eax
80104300:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
...
8010430b:	5d                   	pop    %ebp
  release(&lk->lk);
8010430c:	e9 7f 02 00 00       	jmp    80104590 <release>
80104311:	eb 0d                	jmp    80104320 <releasesleep>
80104313:	90                   	nop
80104314:	90                   	nop
80104315:	90                   	nop
80104316:	90                   	nop
...
80104331:	e8 ea 01 00 00       	call   80104520 <acquire>
  lk->locked = 0;
80104336:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
8010433c:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80104343:	89 1c 24             	mov    %ebx,(%esp)
80104346:	e8 85 fd ff ff       	call   801040d0 <wakeup>
  release(&lk->lk);
8010434b:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
80104353:	5d                   	pop    %ebp
  release(&lk->lk);
80104354:	e9 37 02 00 00       	jmp    80104590 <release>
...
80104368:	83 ec 1c             	sub    $0x1c,%esp
8010436b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
8010436e:	8d 73 04             	lea    0x4(%ebx),%esi
80104371:	89 34 24             	mov    %esi,(%esp)
80104374:	e8 a7 01 00 00       	call   80104520 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104379:	8b 03                	mov    (%ebx),%eax
8010437b:	85 c0                	test   %eax,%eax
8010437d:	74 13                	je     80104392 <holdingsleep+0x32>
8010437f:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80104382:	e8 19 f3 ff ff       	call   801036a0 <myproc>
80104387:	3b 58 10             	cmp    0x10(%eax),%ebx
8010438a:	0f 94 c0             	sete   %al
8010438d:	0f b6 c0             	movzbl %al,%eax
80104390:	89 c7                	mov    %eax,%edi
  release(&lk->lk);
80104392:	89 34 24             	mov    %esi,(%esp)
80104395:	e8 f6 01 00 00       	call   80104590 <release>
  return r;
}
8010439a:	83 c4 1c             	add    $0x1c,%esp
8010439d:	89 f8                	mov    %edi,%eax
8010439f:	5b                   	pop    %ebx
801043a0:	5e                   	pop    %esi
801043a1:	5f                   	pop    %edi
801043a2:	5d                   	pop    %ebp
801043a3:	c3                   	ret    
801043a4:	66 90                	xchg   %ax,%ax
...
{
801043d6:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
80104449:	e8 b2 f1 ff ff       	call   80103600 <mycpu>
8010444e:	81 e3 00 02 00 00    	and    $0x200,%ebx
80104454:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010445a:	e8 a1 f1 ff ff       	call   80103600 <mycpu>
...
8010447b:	75 49                	jne    801044c6 <popcli+0x56>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
8010447d:	e8 7e f1 ff ff       	call   80103600 <mycpu>
...
80104493:	78 25                	js     801044ba <popcli+0x4a>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104495:	e8 66 f1 ff ff       	call   80103600 <mycpu>
8010449a:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
801044a0:	85 d2                	test   %edx,%edx
801044a2:	74 04                	je     801044a8 <popcli+0x38>
    sti();
}
801044a4:	c9                   	leave  
801044a5:	c3                   	ret    
801044a6:	66 90                	xchg   %ax,%ax
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044a8:	e8 53 f1 ff ff       	call   80103600 <mycpu>
801044ad:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
801044b3:	85 c0                	test   %eax,%eax
801044b5:	74 ed                	je     801044a4 <popcli+0x34>
  asm volatile("sti");
801044b7:	fb                   	sti    
}
801044b8:	c9                   	leave  
801044b9:	c3                   	ret    
    panic("popcli");
801044ba:	c7 04 24 da 76 10 80 	movl   $0x801076da,(%esp)
801044c1:	e8 9a be ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
801044c6:	c7 04 24 c3 76 10 80 	movl   $0x801076c3,(%esp)
801044cd:	e8 8e be ff ff       	call   80100360 <panic>
...
801044f3:	74 12                	je     80104507 <holding+0x27>
801044f5:	8b 5b 08             	mov    0x8(%ebx),%ebx
801044f8:	e8 03 f1 ff ff       	call   80103600 <mycpu>
801044fd:	39 c3                	cmp    %eax,%ebx
801044ff:	0f 94 c0             	sete   %al
80104502:	0f b6 c0             	movzbl %al,%eax
80104505:	89 c6                	mov    %eax,%esi
  popcli();
80104507:	e8 64 ff ff ff       	call   80104470 <popcli>
}
8010450c:	89 f0                	mov    %esi,%eax
8010450e:	5b                   	pop    %ebx
8010450f:	5e                   	pop    %esi
80104510:	5d                   	pop    %ebp
80104511:	c3                   	ret    
...
80104527:	e8 04 ff ff ff       	call   80104430 <pushcli>
  if(holding(lk))
8010452c:	8b 45 08             	mov    0x8(%ebp),%eax
8010452f:	89 04 24             	mov    %eax,(%esp)
80104532:	e8 a9 ff ff ff       	call   801044e0 <holding>
80104537:	85 c0                	test   %eax,%eax
80104539:	75 3a                	jne    80104575 <acquire+0x55>
  asm volatile("lock; xchgl %0, %1" :
8010453b:	b9 01 00 00 00       	mov    $0x1,%ecx
  while(xchg(&lk->locked, 1) != 0)
80104540:	8b 55 08             	mov    0x8(%ebp),%edx
80104543:	89 c8                	mov    %ecx,%eax
80104545:	f0 87 02             	lock xchg %eax,(%edx)
80104548:	85 c0                	test   %eax,%eax
8010454a:	75 f4                	jne    80104540 <acquire+0x20>
  __sync_synchronize();
8010454c:	0f ae f0             	mfence 
  lk->cpu = mycpu();
8010454f:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104552:	e8 a9 f0 ff ff       	call   80103600 <mycpu>
80104557:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
8010455a:	8b 45 08             	mov    0x8(%ebp),%eax
8010455d:	83 c0 0c             	add    $0xc,%eax
80104560:	89 44 24 04          	mov    %eax,0x4(%esp)
80104564:	8d 45 08             	lea    0x8(%ebp),%eax
80104567:	89 04 24             	mov    %eax,(%esp)
8010456a:	e8 61 fe ff ff       	call   801043d0 <getcallerpcs>
}
8010456f:	83 c4 14             	add    $0x14,%esp
80104572:	5b                   	pop    %ebx
80104573:	5d                   	pop    %ebp
80104574:	c3                   	ret    
    panic("acquire");
80104575:	c7 04 24 e1 76 10 80 	movl   $0x801076e1,(%esp)
8010457c:	e8 df bd ff ff       	call   80100360 <panic>
...
8010459d:	e8 3e ff ff ff       	call   801044e0 <holding>
801045a2:	85 c0                	test   %eax,%eax
801045a4:	74 21                	je     801045c7 <release+0x37>
  lk->pcs[0] = 0;
801045a6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
801045ad:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
801045b4:	0f ae f0             	mfence 
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
801045b7:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
801045bd:	83 c4 14             	add    $0x14,%esp
801045c0:	5b                   	pop    %ebx
801045c1:	5d                   	pop    %ebp
  popcli();
801045c2:	e9 a9 fe ff ff       	jmp    80104470 <popcli>
    panic("release");
801045c7:	c7 04 24 e9 76 10 80 	movl   $0x801076e9,(%esp)
801045ce:	e8 8d bd ff ff       	call   80100360 <panic>
801045d3:	66 90                	xchg   %ax,%ax
...
80104633:	8b 45 10             	mov    0x10(%ebp),%eax
...
80104641:	8d 78 ff             	lea    -0x1(%eax),%edi
80104644:	74 26                	je     8010466c <memcmp+0x3c>
    if(*s1 != *s2)
80104646:	0f b6 03             	movzbl (%ebx),%eax
80104649:	31 d2                	xor    %edx,%edx
8010464b:	0f b6 0e             	movzbl (%esi),%ecx
8010464e:	38 c8                	cmp    %cl,%al
80104650:	74 16                	je     80104668 <memcmp+0x38>
80104652:	eb 24                	jmp    80104678 <memcmp+0x48>
80104654:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104658:	0f b6 44 13 01       	movzbl 0x1(%ebx,%edx,1),%eax
8010465d:	83 c2 01             	add    $0x1,%edx
80104660:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
80104664:	38 c8                	cmp    %cl,%al
80104666:	75 10                	jne    80104678 <memcmp+0x48>
  while(n-- > 0){
80104668:	39 fa                	cmp    %edi,%edx
...
8010468c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
8010468f:	39 c6                	cmp    %eax,%esi
80104691:	73 35                	jae    801046c8 <memmove+0x48>
80104693:	8d 0c 1e             	lea    (%esi,%ebx,1),%ecx
80104696:	39 c8                	cmp    %ecx,%eax
80104698:	73 2e                	jae    801046c8 <memmove+0x48>
    s += n;
    d += n;
    while(n-- > 0)
8010469a:	85 db                	test   %ebx,%ebx
    d += n;
8010469c:	8d 3c 18             	lea    (%eax,%ebx,1),%edi
    while(n-- > 0)
8010469f:	8d 53 ff             	lea    -0x1(%ebx),%edx
801046a2:	74 1b                	je     801046bf <memmove+0x3f>
801046a4:	f7 db                	neg    %ebx
801046a6:	8d 34 19             	lea    (%ecx,%ebx,1),%esi
801046a9:	01 fb                	add    %edi,%ebx
801046ab:	90                   	nop
801046ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      *--d = *--s;
801046b0:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
801046b4:	88 0c 13             	mov    %cl,(%ebx,%edx,1)
    while(n-- > 0)
801046b7:	83 ea 01             	sub    $0x1,%edx
801046ba:	83 fa ff             	cmp    $0xffffffff,%edx
801046bd:	75 f1                	jne    801046b0 <memmove+0x30>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
801046cc:	74 f1                	je     801046bf <memmove+0x3f>
...
80104708:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010470b:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  while(n > 0 && *p && *p == *q)
8010470e:	85 f6                	test   %esi,%esi
80104710:	74 30                	je     80104742 <strncmp+0x42>
80104712:	0f b6 01             	movzbl (%ecx),%eax
80104715:	84 c0                	test   %al,%al
80104717:	74 2f                	je     80104748 <strncmp+0x48>
80104719:	0f b6 13             	movzbl (%ebx),%edx
8010471c:	38 d0                	cmp    %dl,%al
8010471e:	75 46                	jne    80104766 <strncmp+0x66>
80104720:	8d 51 01             	lea    0x1(%ecx),%edx
80104723:	01 ce                	add    %ecx,%esi
80104725:	eb 14                	jmp    8010473b <strncmp+0x3b>
80104727:	90                   	nop
80104728:	0f b6 02             	movzbl (%edx),%eax
8010472b:	84 c0                	test   %al,%al
8010472d:	74 31                	je     80104760 <strncmp+0x60>
8010472f:	0f b6 19             	movzbl (%ecx),%ebx
80104732:	83 c2 01             	add    $0x1,%edx
80104735:	38 d8                	cmp    %bl,%al
80104737:	75 17                	jne    80104750 <strncmp+0x50>
    n--, p++, q++;
80104739:	89 cb                	mov    %ecx,%ebx
  while(n > 0 && *p && *p == *q)
8010473b:	39 f2                	cmp    %esi,%edx
    n--, p++, q++;
8010473d:	8d 4b 01             	lea    0x1(%ebx),%ecx
  while(n > 0 && *p && *p == *q)
...
80104746:	5d                   	pop    %ebp
80104747:	c3                   	ret    
80104748:	0f b6 1b             	movzbl (%ebx),%ebx
  while(n > 0 && *p && *p == *q)
8010474b:	31 c0                	xor    %eax,%eax
8010474d:	8d 76 00             	lea    0x0(%esi),%esi
  return (uchar)*p - (uchar)*q;
80104750:	0f b6 d3             	movzbl %bl,%edx
80104753:	29 d0                	sub    %edx,%eax
}
80104755:	5b                   	pop    %ebx
80104756:	5e                   	pop    %esi
80104757:	5d                   	pop    %ebp
...
80104760:	0f b6 5b 01          	movzbl 0x1(%ebx),%ebx
80104764:	eb ea                	jmp    80104750 <strncmp+0x50>
  while(n > 0 && *p && *p == *q)
80104766:	89 d3                	mov    %edx,%ebx
80104768:	eb e6                	jmp    80104750 <strncmp+0x50>
...
8010477b:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  char *os;
...
801047a6:	7e 0f                	jle    801047b7 <strncpy+0x47>
    *s++ = 0;
801047a8:	c6 04 0a 00          	movb   $0x0,(%edx,%ecx,1)
801047ac:	89 f3                	mov    %esi,%ebx
801047ae:	83 c1 01             	add    $0x1,%ecx
801047b1:	29 cb                	sub    %ecx,%ebx
  while(n-- > 0)
801047b3:	85 db                	test   %ebx,%ebx
801047b5:	7f f1                	jg     801047a8 <strncpy+0x38>
  return os;
}
801047b7:	5b                   	pop    %ebx
801047b8:	5e                   	pop    %esi
...
801047c3:	8b 4d 10             	mov    0x10(%ebp),%ecx
...
80104837:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010483a:	e8 61 ee ff ff       	call   801036a0 <myproc>
...
80104877:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010487a:	e8 21 ee ff ff       	call   801036a0 <myproc>

  if(addr >= curproc->sz)
8010487f:	39 18                	cmp    %ebx,(%eax)
80104881:	76 26                	jbe    801048a9 <fetchstr+0x39>
    return -1;
  *pp = (char*)addr;
...
8010488e:	73 19                	jae    801048a9 <fetchstr+0x39>
    if(*s == 0)
80104890:	80 3b 00             	cmpb   $0x0,(%ebx)
80104893:	75 0d                	jne    801048a2 <fetchstr+0x32>
80104895:	eb 21                	jmp    801048b8 <fetchstr+0x48>
80104897:	90                   	nop
80104898:	80 3a 00             	cmpb   $0x0,(%edx)
8010489b:	90                   	nop
8010489c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801048a0:	74 16                	je     801048b8 <fetchstr+0x48>
  for(s = *pp; s < ep; s++){
801048a2:	83 c2 01             	add    $0x1,%edx
801048a5:	39 d0                	cmp    %edx,%eax
801048a7:	77 ef                	ja     80104898 <fetchstr+0x28>
      return s - *pp;
  }
  return -1;
}
801048a9:	83 c4 04             	add    $0x4,%esp
    return -1;
...
int
argint(int n, int *ip) //n = is the argument number and *ip stores the value at the address
{
801048d0:	55                   	push   %ebp
801048d1:	89 e5                	mov    %esp,%ebp
801048d3:	56                   	push   %esi
801048d4:	8b 75 0c             	mov    0xc(%ebp),%esi
801048d7:	53                   	push   %ebx
801048d8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801048db:	e8 c0 ed ff ff       	call   801036a0 <myproc>
801048e0:	89 75 0c             	mov    %esi,0xc(%ebp)
801048e3:	8b 40 18             	mov    0x18(%eax),%eax
801048e6:	8b 40 44             	mov    0x44(%eax),%eax
801048e9:	8d 44 98 04          	lea    0x4(%eax,%ebx,4),%eax
801048ed:	89 45 08             	mov    %eax,0x8(%ebp)
}
801048f0:	5b                   	pop    %ebx
801048f1:	5e                   	pop    %esi
801048f2:	5d                   	pop    %ebp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801048f3:	e9 38 ff ff ff       	jmp    80104830 <fetchint>
801048f8:	90                   	nop
...
80104905:	83 ec 20             	sub    $0x20,%esp
80104908:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010490b:	e8 90 ed ff ff       	call   801036a0 <myproc>
...
8010491f:	e8 ac ff ff ff       	call   801048d0 <argint>
...
8010492c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010492f:	8b 06                	mov    (%esi),%eax
80104931:	39 c2                	cmp    %eax,%edx
80104933:	73 1b                	jae    80104950 <argptr+0x50>
80104935:	01 d3                	add    %edx,%ebx
80104937:	39 d8                	cmp    %ebx,%eax
...
80104973:	e8 58 ff ff ff       	call   801048d0 <argint>
80104978:	85 c0                	test   %eax,%eax
8010497a:	78 14                	js     80104990 <argstr+0x30>
    return -1;
...
80104989:	e8 e2 fe ff ff       	call   80104870 <fetchstr>
}
8010498e:	c9                   	leave  
8010498f:	c3                   	ret    
    return -1;
...
801049a5:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
801049a8:	e8 f3 ec ff ff       	call   801036a0 <myproc>

  num = curproc->tf->eax;
801049ad:	8b 70 18             	mov    0x18(%eax),%esi
  struct proc *curproc = myproc();
801049b0:	89 c3                	mov    %eax,%ebx
  num = curproc->tf->eax;
801049b2:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801049b5:	8d 50 ff             	lea    -0x1(%eax),%edx
801049b8:	83 fa 17             	cmp    $0x17,%edx
801049bb:	77 1b                	ja     801049d8 <syscall+0x38>
801049bd:	8b 14 85 20 77 10 80 	mov    -0x7fef88e0(,%eax,4),%edx
801049c4:	85 d2                	test   %edx,%edx
801049c6:	74 10                	je     801049d8 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
801049c8:	ff d2                	call   *%edx
801049ca:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
801049d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("%d %s: unknown sys call %d\n",
801049d8:	89 44 24 0c          	mov    %eax,0xc(%esp)
            curproc->pid, curproc->name, num);
801049dc:	8d 43 6c             	lea    0x6c(%ebx),%eax
801049df:	89 44 24 08          	mov    %eax,0x8(%esp)
    cprintf("%d %s: unknown sys call %d\n",
801049e3:	8b 43 10             	mov    0x10(%ebx),%eax
801049e6:	c7 04 24 f1 76 10 80 	movl   $0x801076f1,(%esp)
801049ed:	89 44 24 04          	mov    %eax,0x4(%esp)
801049f1:	e8 5a bc ff ff       	call   80100650 <cprintf>
    curproc->tf->eax = -1;
801049f6:	8b 43 18             	mov    0x18(%ebx),%eax
801049f9:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
80104a16:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
80104a19:	e8 82 ec ff ff       	call   801036a0 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
80104a1e:	31 d2                	xor    %edx,%edx
    if(curproc->ofile[fd] == 0){
80104a20:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
80104a24:	85 c9                	test   %ecx,%ecx
80104a26:	74 18                	je     80104a40 <fdalloc+0x30>
  for(fd = 0; fd < NOFILE; fd++){
80104a28:	83 c2 01             	add    $0x1,%edx
80104a2b:	83 fa 10             	cmp    $0x10,%edx
80104a2e:	75 f0                	jne    80104a20 <fdalloc+0x10>
      curproc->ofile[fd] = f;
      return fd;
    }
  }
...
80104a3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
80104a40:	89 5c 90 28          	mov    %ebx,0x28(%eax,%edx,4)
}
80104a44:	83 c4 04             	add    $0x4,%esp
      return fd;
...
80104a59:	89 4d d0             	mov    %ecx,-0x30(%ebp)
80104a5c:	8b 4d 08             	mov    0x8(%ebp),%ecx
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80104a5f:	8d 5d da             	lea    -0x26(%ebp),%ebx
80104a62:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104a66:	89 04 24             	mov    %eax,(%esp)
{
80104a69:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104a6c:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104a6f:	e8 ac d4 ff ff       	call   80101f20 <nameiparent>
80104a74:	85 c0                	test   %eax,%eax
80104a76:	89 c7                	mov    %eax,%edi
80104a78:	0f 84 da 00 00 00    	je     80104b58 <create+0x108>
    return 0;
  ilock(dp);
80104a7e:	89 04 24             	mov    %eax,(%esp)
80104a81:	e8 2a cc ff ff       	call   801016b0 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104a86:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80104a8d:	00 
80104a8e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104a92:	89 3c 24             	mov    %edi,(%esp)
80104a95:	e8 26 d1 ff ff       	call   80101bc0 <dirlookup>
80104a9a:	85 c0                	test   %eax,%eax
80104a9c:	89 c6                	mov    %eax,%esi
80104a9e:	74 40                	je     80104ae0 <create+0x90>
    iunlockput(dp);
80104aa0:	89 3c 24             	mov    %edi,(%esp)
80104aa3:	e8 68 ce ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80104aa8:	89 34 24             	mov    %esi,(%esp)
80104aab:	e8 00 cc ff ff       	call   801016b0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104ab0:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104ab5:	75 11                	jne    80104ac8 <create+0x78>
80104ab7:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104abc:	89 f0                	mov    %esi,%eax
80104abe:	75 08                	jne    80104ac8 <create+0x78>
...
80104ac0:	83 c4 3c             	add    $0x3c,%esp
80104ac3:	5b                   	pop    %ebx
80104ac4:	5e                   	pop    %esi
80104ac5:	5f                   	pop    %edi
80104ac6:	5d                   	pop    %ebp
...
80104acb:	e8 40 ce ff ff       	call   80101910 <iunlockput>
}
...
80104ae8:	8b 07                	mov    (%edi),%eax
80104aea:	89 04 24             	mov    %eax,(%esp)
80104aed:	e8 2e ca ff ff       	call   80101520 <ialloc>
80104af2:	85 c0                	test   %eax,%eax
80104af4:	89 c6                	mov    %eax,%esi
80104af6:	0f 84 bf 00 00 00    	je     80104bbb <create+0x16b>
  ilock(ip);
80104afc:	89 04 24             	mov    %eax,(%esp)
80104aff:	e8 ac cb ff ff       	call   801016b0 <ilock>
  ip->major = major;
80104b04:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80104b08:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
80104b0c:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80104b10:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80104b14:	b8 01 00 00 00       	mov    $0x1,%eax
80104b19:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
80104b1d:	89 34 24             	mov    %esi,(%esp)
80104b20:	e8 cb ca ff ff       	call   801015f0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104b25:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80104b2a:	74 34                	je     80104b60 <create+0x110>
  if(dirlink(dp, name, ip->inum) < 0)
80104b2c:	8b 46 04             	mov    0x4(%esi),%eax
80104b2f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
...
80104b41:	78 6c                	js     80104baf <create+0x15f>
  iunlockput(dp);
80104b43:	89 3c 24             	mov    %edi,(%esp)
80104b46:	e8 c5 cd ff ff       	call   80101910 <iunlockput>
}
80104b4b:	83 c4 3c             	add    $0x3c,%esp
  return ip;
80104b4e:	89 f0                	mov    %esi,%eax
}
80104b50:	5b                   	pop    %ebx
80104b51:	5e                   	pop    %esi
80104b52:	5f                   	pop    %edi
...
80104b5a:	e9 61 ff ff ff       	jmp    80104ac0 <create+0x70>
80104b5f:	90                   	nop
    dp->nlink++;  // for ".."
...
80104b6d:	8b 46 04             	mov    0x4(%esi),%eax
80104b70:	c7 44 24 04 a0 77 10 	movl   $0x801077a0,0x4(%esp)
80104b77:	80 
80104b78:	89 34 24             	mov    %esi,(%esp)
80104b7b:	89 44 24 08          	mov    %eax,0x8(%esp)
80104b7f:	e8 9c d2 ff ff       	call   80101e20 <dirlink>
80104b84:	85 c0                	test   %eax,%eax
80104b86:	78 1b                	js     80104ba3 <create+0x153>
80104b88:	8b 47 04             	mov    0x4(%edi),%eax
80104b8b:	c7 44 24 04 9f 77 10 	movl   $0x8010779f,0x4(%esp)
80104b92:	80 
...
80104ba1:	79 89                	jns    80104b2c <create+0xdc>
      panic("create dots");
80104ba3:	c7 04 24 93 77 10 80 	movl   $0x80107793,(%esp)
80104baa:	e8 b1 b7 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
80104baf:	c7 04 24 a2 77 10 80 	movl   $0x801077a2,(%esp)
80104bb6:	e8 a5 b7 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
80104bbb:	c7 04 24 84 77 10 80 	movl   $0x80107784,(%esp)
80104bc2:	e8 99 b7 ff ff       	call   80100360 <panic>
...
80104bd7:	89 d3                	mov    %edx,%ebx
80104bd9:	83 ec 20             	sub    $0x20,%esp
  if(argint(n, &fd) < 0)
80104bdc:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104bdf:	89 44 24 04          	mov    %eax,0x4(%esp)
80104be3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104bea:	e8 e1 fc ff ff       	call   801048d0 <argint>
80104bef:	85 c0                	test   %eax,%eax
80104bf1:	78 2d                	js     80104c20 <argfd.constprop.0+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104bf3:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104bf7:	77 27                	ja     80104c20 <argfd.constprop.0+0x50>
80104bf9:	e8 a2 ea ff ff       	call   801036a0 <myproc>
80104bfe:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104c01:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104c05:	85 c0                	test   %eax,%eax
80104c07:	74 17                	je     80104c20 <argfd.constprop.0+0x50>
  if(pfd)
80104c09:	85 f6                	test   %esi,%esi
80104c0b:	74 02                	je     80104c0f <argfd.constprop.0+0x3f>
    *pfd = fd;
80104c0d:	89 16                	mov    %edx,(%esi)
  if(pf)
80104c0f:	85 db                	test   %ebx,%ebx
80104c11:	74 1d                	je     80104c30 <argfd.constprop.0+0x60>
    *pf = f;
80104c13:	89 03                	mov    %eax,(%ebx)
  return 0;
80104c15:	31 c0                	xor    %eax,%eax
}
80104c17:	83 c4 20             	add    $0x20,%esp
80104c1a:	5b                   	pop    %ebx
80104c1b:	5e                   	pop    %esi
80104c1c:	5d                   	pop    %ebp
80104c1d:	c3                   	ret    
...
80104c32:	eb e3                	jmp    80104c17 <argfd.constprop.0+0x47>
...
80104c46:	83 ec 24             	sub    $0x24,%esp
  if(argfd(0, 0, &f) < 0)
80104c49:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104c4c:	e8 7f ff ff ff       	call   80104bd0 <argfd.constprop.0>
80104c51:	85 c0                	test   %eax,%eax
80104c53:	78 23                	js     80104c78 <sys_dup+0x38>
  if((fd=fdalloc(f)) < 0)
80104c55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c58:	e8 b3 fd ff ff       	call   80104a10 <fdalloc>
80104c5d:	85 c0                	test   %eax,%eax
80104c5f:	89 c3                	mov    %eax,%ebx
80104c61:	78 15                	js     80104c78 <sys_dup+0x38>
  filedup(f);
80104c63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c66:	89 04 24             	mov    %eax,(%esp)
80104c69:	e8 72 c1 ff ff       	call   80100de0 <filedup>
  return fd;
80104c6e:	89 d8                	mov    %ebx,%eax
}
80104c70:	83 c4 24             	add    $0x24,%esp
80104c73:	5b                   	pop    %ebx
80104c74:	5d                   	pop    %ebp
80104c75:	c3                   	ret    
...
80104c7d:	eb f1                	jmp    80104c70 <sys_dup+0x30>
80104c7f:	90                   	nop
...
80104c8b:	e8 40 ff ff ff       	call   80104bd0 <argfd.constprop.0>
80104c90:	85 c0                	test   %eax,%eax
80104c92:	78 54                	js     80104ce8 <sys_read+0x68>
80104c94:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104c97:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c9b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80104ca2:	e8 29 fc ff ff       	call   801048d0 <argint>
80104ca7:	85 c0                	test   %eax,%eax
80104ca9:	78 3d                	js     80104ce8 <sys_read+0x68>
...
80104cc0:	e8 3b fc ff ff       	call   80104900 <argptr>
80104cc5:	85 c0                	test   %eax,%eax
80104cc7:	78 1f                	js     80104ce8 <sys_read+0x68>
...
80104cfb:	e8 d0 fe ff ff       	call   80104bd0 <argfd.constprop.0>
80104d00:	85 c0                	test   %eax,%eax
80104d02:	78 54                	js     80104d58 <sys_write+0x68>
80104d04:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d07:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d0b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80104d12:	e8 b9 fb ff ff       	call   801048d0 <argint>
80104d17:	85 c0                	test   %eax,%eax
80104d19:	78 3d                	js     80104d58 <sys_write+0x68>
...
80104d30:	e8 cb fb ff ff       	call   80104900 <argptr>
80104d35:	85 c0                	test   %eax,%eax
80104d37:	78 1f                	js     80104d58 <sys_write+0x68>
...
80104d6c:	e8 5f fe ff ff       	call   80104bd0 <argfd.constprop.0>
80104d71:	85 c0                	test   %eax,%eax
80104d73:	78 23                	js     80104d98 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104d75:	e8 26 e9 ff ff       	call   801036a0 <myproc>
80104d7a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104d7d:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104d84:	00 
  fileclose(f);
...
80104dab:	e8 20 fe ff ff       	call   80104bd0 <argfd.constprop.0>
80104db0:	85 c0                	test   %eax,%eax
80104db2:	78 34                	js     80104de8 <sys_fstat+0x48>
80104db4:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104db7:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80104dbe:	00 
80104dbf:	89 44 24 04          	mov    %eax,0x4(%esp)
80104dc3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104dca:	e8 31 fb ff ff       	call   80104900 <argptr>
80104dcf:	85 c0                	test   %eax,%eax
80104dd1:	78 15                	js     80104de8 <sys_fstat+0x48>
...
80104de0:	e8 0b c1 ff ff       	call   80100ef0 <filestat>
}
80104de5:	c9                   	leave  
80104de6:	c3                   	ret    
80104de7:	90                   	nop
...
80104df6:	83 ec 3c             	sub    $0x3c,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80104df9:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80104dfc:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e00:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104e07:	e8 54 fb ff ff       	call   80104960 <argstr>
80104e0c:	85 c0                	test   %eax,%eax
80104e0e:	0f 88 e6 00 00 00    	js     80104efa <sys_link+0x10a>
80104e14:	8d 45 d0             	lea    -0x30(%ebp),%eax
80104e17:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e1b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104e22:	e8 39 fb ff ff       	call   80104960 <argstr>
80104e27:	85 c0                	test   %eax,%eax
80104e29:	0f 88 cb 00 00 00    	js     80104efa <sys_link+0x10a>
  begin_op();
80104e2f:	e8 dc dc ff ff       	call   80102b10 <begin_op>
  if((ip = namei(old)) == 0){
80104e34:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104e37:	89 04 24             	mov    %eax,(%esp)
80104e3a:	e8 c1 d0 ff ff       	call   80101f00 <namei>
80104e3f:	85 c0                	test   %eax,%eax
80104e41:	89 c3                	mov    %eax,%ebx
80104e43:	0f 84 ac 00 00 00    	je     80104ef5 <sys_link+0x105>
  ilock(ip);
80104e49:	89 04 24             	mov    %eax,(%esp)
80104e4c:	e8 5f c8 ff ff       	call   801016b0 <ilock>
  if(ip->type == T_DIR){
80104e51:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104e56:	0f 84 91 00 00 00    	je     80104eed <sys_link+0xfd>
  ip->nlink++;
80104e5c:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80104e61:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80104e64:	89 1c 24             	mov    %ebx,(%esp)
80104e67:	e8 84 c7 ff ff       	call   801015f0 <iupdate>
  iunlock(ip);
80104e6c:	89 1c 24             	mov    %ebx,(%esp)
80104e6f:	e8 1c c9 ff ff       	call   80101790 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104e74:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104e77:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104e7b:	89 04 24             	mov    %eax,(%esp)
80104e7e:	e8 9d d0 ff ff       	call   80101f20 <nameiparent>
80104e83:	85 c0                	test   %eax,%eax
80104e85:	89 c6                	mov    %eax,%esi
80104e87:	74 4f                	je     80104ed8 <sys_link+0xe8>
  ilock(dp);
80104e89:	89 04 24             	mov    %eax,(%esp)
80104e8c:	e8 1f c8 ff ff       	call   801016b0 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104e91:	8b 03                	mov    (%ebx),%eax
80104e93:	39 06                	cmp    %eax,(%esi)
80104e95:	75 39                	jne    80104ed0 <sys_link+0xe0>
80104e97:	8b 43 04             	mov    0x4(%ebx),%eax
80104e9a:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104e9e:	89 34 24             	mov    %esi,(%esp)
80104ea1:	89 44 24 08          	mov    %eax,0x8(%esp)
80104ea5:	e8 76 cf ff ff       	call   80101e20 <dirlink>
80104eaa:	85 c0                	test   %eax,%eax
80104eac:	78 22                	js     80104ed0 <sys_link+0xe0>
  iunlockput(dp);
80104eae:	89 34 24             	mov    %esi,(%esp)
80104eb1:	e8 5a ca ff ff       	call   80101910 <iunlockput>
  iput(ip);
80104eb6:	89 1c 24             	mov    %ebx,(%esp)
80104eb9:	e8 12 c9 ff ff       	call   801017d0 <iput>
  end_op();
80104ebe:	e8 bd dc ff ff       	call   80102b80 <end_op>
}
80104ec3:	83 c4 3c             	add    $0x3c,%esp
  return 0;
80104ec6:	31 c0                	xor    %eax,%eax
}
80104ec8:	5b                   	pop    %ebx
80104ec9:	5e                   	pop    %esi
80104eca:	5f                   	pop    %edi
...
80104ed3:	e8 38 ca ff ff       	call   80101910 <iunlockput>
  ilock(ip);
80104ed8:	89 1c 24             	mov    %ebx,(%esp)
80104edb:	e8 d0 c7 ff ff       	call   801016b0 <ilock>
  ip->nlink--;
...
80104efa:	83 c4 3c             	add    $0x3c,%esp
  return -1;
...
80104f16:	83 ec 5c             	sub    $0x5c,%esp
  if(argstr(0, &path) < 0)
80104f19:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104f1c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f20:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104f27:	e8 34 fa ff ff       	call   80104960 <argstr>
80104f2c:	85 c0                	test   %eax,%eax
80104f2e:	0f 88 76 01 00 00    	js     801050aa <sys_unlink+0x19a>
  begin_op();
80104f34:	e8 d7 db ff ff       	call   80102b10 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104f39:	8b 45 c0             	mov    -0x40(%ebp),%eax
80104f3c:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80104f3f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104f43:	89 04 24             	mov    %eax,(%esp)
80104f46:	e8 d5 cf ff ff       	call   80101f20 <nameiparent>
80104f4b:	85 c0                	test   %eax,%eax
80104f4d:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80104f50:	0f 84 4f 01 00 00    	je     801050a5 <sys_unlink+0x195>
  ilock(dp);
80104f56:	8b 75 b4             	mov    -0x4c(%ebp),%esi
80104f59:	89 34 24             	mov    %esi,(%esp)
80104f5c:	e8 4f c7 ff ff       	call   801016b0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104f61:	c7 44 24 04 a0 77 10 	movl   $0x801077a0,0x4(%esp)
80104f68:	80 
80104f69:	89 1c 24             	mov    %ebx,(%esp)
80104f6c:	e8 1f cc ff ff       	call   80101b90 <namecmp>
80104f71:	85 c0                	test   %eax,%eax
80104f73:	0f 84 21 01 00 00    	je     8010509a <sys_unlink+0x18a>
80104f79:	c7 44 24 04 9f 77 10 	movl   $0x8010779f,0x4(%esp)
80104f80:	80 
80104f81:	89 1c 24             	mov    %ebx,(%esp)
80104f84:	e8 07 cc ff ff       	call   80101b90 <namecmp>
80104f89:	85 c0                	test   %eax,%eax
80104f8b:	0f 84 09 01 00 00    	je     8010509a <sys_unlink+0x18a>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104f91:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80104f94:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104f98:	89 44 24 08          	mov    %eax,0x8(%esp)
80104f9c:	89 34 24             	mov    %esi,(%esp)
80104f9f:	e8 1c cc ff ff       	call   80101bc0 <dirlookup>
80104fa4:	85 c0                	test   %eax,%eax
80104fa6:	89 c3                	mov    %eax,%ebx
80104fa8:	0f 84 ec 00 00 00    	je     8010509a <sys_unlink+0x18a>
  ilock(ip);
80104fae:	89 04 24             	mov    %eax,(%esp)
80104fb1:	e8 fa c6 ff ff       	call   801016b0 <ilock>
  if(ip->nlink < 1)
80104fb6:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104fbb:	0f 8e 24 01 00 00    	jle    801050e5 <sys_unlink+0x1d5>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104fc1:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104fc6:	8d 75 d8             	lea    -0x28(%ebp),%esi
80104fc9:	74 7d                	je     80105048 <sys_unlink+0x138>
  memset(&de, 0, sizeof(de));
80104fcb:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104fd2:	00 
80104fd3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104fda:	00 
80104fdb:	89 34 24             	mov    %esi,(%esp)
80104fde:	e8 fd f5 ff ff       	call   801045e0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104fe3:	8b 45 c4             	mov    -0x3c(%ebp),%eax
80104fe6:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80104fed:	00 
80104fee:	89 74 24 04          	mov    %esi,0x4(%esp)
80104ff2:	89 44 24 08          	mov    %eax,0x8(%esp)
80104ff6:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104ff9:	89 04 24             	mov    %eax,(%esp)
80104ffc:	e8 5f ca ff ff       	call   80101a60 <writei>
80105001:	83 f8 10             	cmp    $0x10,%eax
80105004:	0f 85 cf 00 00 00    	jne    801050d9 <sys_unlink+0x1c9>
  if(ip->type == T_DIR){
8010500a:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010500f:	0f 84 a3 00 00 00    	je     801050b8 <sys_unlink+0x1a8>
  iunlockput(dp);
80105015:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80105018:	89 04 24             	mov    %eax,(%esp)
8010501b:	e8 f0 c8 ff ff       	call   80101910 <iunlockput>
  ip->nlink--;
80105020:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105025:	89 1c 24             	mov    %ebx,(%esp)
80105028:	e8 c3 c5 ff ff       	call   801015f0 <iupdate>
  iunlockput(ip);
...
80105048:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
8010504c:	0f 86 79 ff ff ff    	jbe    80104fcb <sys_unlink+0xbb>
80105052:	bf 20 00 00 00       	mov    $0x20,%edi
80105057:	eb 15                	jmp    8010506e <sys_unlink+0x15e>
80105059:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105060:	8d 57 10             	lea    0x10(%edi),%edx
80105063:	3b 53 58             	cmp    0x58(%ebx),%edx
80105066:	0f 83 5f ff ff ff    	jae    80104fcb <sys_unlink+0xbb>
8010506c:	89 d7                	mov    %edx,%edi
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010506e:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105075:	00 
80105076:	89 7c 24 08          	mov    %edi,0x8(%esp)
8010507a:	89 74 24 04          	mov    %esi,0x4(%esp)
8010507e:	89 1c 24             	mov    %ebx,(%esp)
80105081:	e8 da c8 ff ff       	call   80101960 <readi>
80105086:	83 f8 10             	cmp    $0x10,%eax
80105089:	75 42                	jne    801050cd <sys_unlink+0x1bd>
    if(de.inum != 0)
8010508b:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80105090:	74 ce                	je     80105060 <sys_unlink+0x150>
    iunlockput(ip);
80105092:	89 1c 24             	mov    %ebx,(%esp)
80105095:	e8 76 c8 ff ff       	call   80101910 <iunlockput>
  iunlockput(dp);
8010509a:	8b 45 b4             	mov    -0x4c(%ebp),%eax
...
801050bb:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
801050c0:	89 04 24             	mov    %eax,(%esp)
801050c3:	e8 28 c5 ff ff       	call   801015f0 <iupdate>
801050c8:	e9 48 ff ff ff       	jmp    80105015 <sys_unlink+0x105>
      panic("isdirempty: readi");
801050cd:	c7 04 24 c4 77 10 80 	movl   $0x801077c4,(%esp)
801050d4:	e8 87 b2 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
801050d9:	c7 04 24 d6 77 10 80 	movl   $0x801077d6,(%esp)
801050e0:	e8 7b b2 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
801050e5:	c7 04 24 b2 77 10 80 	movl   $0x801077b2,(%esp)
801050ec:	e8 6f b2 ff ff       	call   80100360 <panic>
...
80105106:	83 ec 2c             	sub    $0x2c,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105109:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010510c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105110:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105117:	e8 44 f8 ff ff       	call   80104960 <argstr>
8010511c:	85 c0                	test   %eax,%eax
8010511e:	0f 88 d1 00 00 00    	js     801051f5 <sys_open+0xf5>
80105124:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105127:	89 44 24 04          	mov    %eax,0x4(%esp)
8010512b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105132:	e8 99 f7 ff ff       	call   801048d0 <argint>
80105137:	85 c0                	test   %eax,%eax
80105139:	0f 88 b6 00 00 00    	js     801051f5 <sys_open+0xf5>
    return -1;
...
8010513f:	e8 cc d9 ff ff       	call   80102b10 <begin_op>
  ...
  if(omode & O_CREATE){
80105144:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105148:	0f 85 82 00 00 00    	jne    801051d0 <sys_open+0xd0>
    if(ip == 0){
      end_op();
      return -1;
    }
    ...
    if((ip = namei(path)) == 0){
8010514e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105151:	89 04 24             	mov    %eax,(%esp)
80105154:	e8 a7 cd ff ff       	call   80101f00 <namei>
80105159:	85 c0                	test   %eax,%eax
8010515b:	89 c6                	mov    %eax,%esi
8010515d:	0f 84 8d 00 00 00    	je     801051f0 <sys_open+0xf0>
      end_op();
      return -1;
    }
    ilock(ip);
80105163:	89 04 24             	mov    %eax,(%esp)
80105166:	e8 45 c5 ff ff       	call   801016b0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010516b:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105170:	0f 84 92 00 00 00    	je     80105208 <sys_open+0x108>
      end_op();
      return -1;
    }
  }
...
8010517f:	0f 84 93 00 00 00    	je     80105218 <sys_open+0x118>
80105185:	e8 86 f8 ff ff       	call   80104a10 <fdalloc>
8010518a:	85 c0                	test   %eax,%eax
8010518c:	89 c7                	mov    %eax,%edi
8010518e:	0f 88 94 00 00 00    	js     80105228 <sys_open+0x128>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
  ...
  iunlock(ip);
80105194:	89 34 24             	mov    %esi,(%esp)
80105197:	e8 f4 c5 ff ff       	call   80101790 <iunlock>
  end_op();
8010519c:	e8 df d9 ff ff       	call   80102b80 <end_op>

  f->type = FD_INODE;
801051a1:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
801051a7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  f->ip = ip;
801051aa:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
801051ad:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
801051b4:	89 c2                	mov    %eax,%edx
801051b6:	83 e2 01             	and    $0x1,%edx
801051b9:	83 f2 01             	xor    $0x1,%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801051bc:	a8 03                	test   $0x3,%al
  f->readable = !(omode & O_WRONLY);
801051be:	88 53 08             	mov    %dl,0x8(%ebx)
  return fd;
801051c1:	89 f8                	mov    %edi,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801051c3:	0f 95 43 09          	setne  0x9(%ebx)
}
801051c7:	83 c4 2c             	add    $0x2c,%esp
801051ca:	5b                   	pop    %ebx
801051cb:	5e                   	pop    %esi
801051cc:	5f                   	pop    %edi
801051cd:	5d                   	pop    %ebp
...
801051d3:	31 c9                	xor    %ecx,%ecx
801051d5:	ba 02 00 00 00       	mov    $0x2,%edx
801051da:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801051e1:	e8 6a f8 ff ff       	call   80104a50 <create>
    if(ip == 0){
801051e6:	85 c0                	test   %eax,%eax
    ip = create(path, T_FILE, 0, 0);
801051e8:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801051ea:	75 8a                	jne    80105176 <sys_open+0x76>
801051ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    end_op();
801051f0:	e8 8b d9 ff ff       	call   80102b80 <end_op>
}
801051f5:	83 c4 2c             	add    $0x2c,%esp
    return -1;
...
8010520d:	0f 84 63 ff ff ff    	je     80105176 <sys_open+0x76>
80105213:	90                   	nop
80105214:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    iunlockput(ip);
80105218:	89 34 24             	mov    %esi,(%esp)
8010521b:	e8 f0 c6 ff ff       	call   80101910 <iunlockput>
80105220:	eb ce                	jmp    801051f0 <sys_open+0xf0>
80105222:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      fileclose(f);
80105228:	89 1c 24             	mov    %ebx,(%esp)
8010522b:	e8 00 bc ff ff       	call   80100e30 <fileclose>
80105230:	eb e6                	jmp    80105218 <sys_open+0x118>
...
80105259:	e8 02 f7 ff ff       	call   80104960 <argstr>
8010525e:	85 c0                	test   %eax,%eax
80105260:	78 2e                	js     80105290 <sys_mkdir+0x50>
80105262:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105265:	31 c9                	xor    %ecx,%ecx
80105267:	ba 01 00 00 00       	mov    $0x1,%edx
8010526c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105273:	e8 d8 f7 ff ff       	call   80104a50 <create>
80105278:	85 c0                	test   %eax,%eax
8010527a:	74 14                	je     80105290 <sys_mkdir+0x50>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
8010527f:	e8 8c c6 ff ff       	call   80101910 <iunlockput>
  end_op();
80105284:	e8 f7 d8 ff ff       	call   80102b80 <end_op>
  return 0;
...
8010528d:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
80105290:	e8 eb d8 ff ff       	call   80102b80 <end_op>
    return -1;
...
801052a3:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801052a6:	e8 65 d8 ff ff       	call   80102b10 <begin_op>
  if((argstr(0, &path)) < 0 ||
801052ab:	8d 45 ec             	lea    -0x14(%ebp),%eax
801052ae:	89 44 24 04          	mov    %eax,0x4(%esp)
801052b2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801052b9:	e8 a2 f6 ff ff       	call   80104960 <argstr>
801052be:	85 c0                	test   %eax,%eax
801052c0:	78 5e                	js     80105320 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
801052c2:	8d 45 f0             	lea    -0x10(%ebp),%eax
801052c5:	89 44 24 04          	mov    %eax,0x4(%esp)
801052c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801052d0:	e8 fb f5 ff ff       	call   801048d0 <argint>
  if((argstr(0, &path)) < 0 ||
801052d5:	85 c0                	test   %eax,%eax
801052d7:	78 47                	js     80105320 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
801052d9:	8d 45 f4             	lea    -0xc(%ebp),%eax
801052dc:	89 44 24 04          	mov    %eax,0x4(%esp)
801052e0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801052e7:	e8 e4 f5 ff ff       	call   801048d0 <argint>
     argint(1, &major) < 0 ||
801052ec:	85 c0                	test   %eax,%eax
801052ee:	78 30                	js     80105320 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
801052f0:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
     argint(2, &minor) < 0 ||
801052f4:	ba 03 00 00 00       	mov    $0x3,%edx
     (ip = create(path, T_DEV, major, minor)) == 0){
801052f9:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
801052fd:	89 04 24             	mov    %eax,(%esp)
     argint(2, &minor) < 0 ||
80105300:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105303:	e8 48 f7 ff ff       	call   80104a50 <create>
80105308:	85 c0                	test   %eax,%eax
8010530a:	74 14                	je     80105320 <sys_mknod+0x80>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
8010530f:	e8 fc c5 ff ff       	call   80101910 <iunlockput>
  end_op();
80105314:	e8 67 d8 ff ff       	call   80102b80 <end_op>
  return 0;
...
8010531d:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
80105320:	e8 5b d8 ff ff       	call   80102b80 <end_op>
    return -1;
...
80105335:	83 ec 20             	sub    $0x20,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
80105338:	e8 63 e3 ff ff       	call   801036a0 <myproc>
8010533d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010533f:	e8 cc d7 ff ff       	call   80102b10 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105344:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105347:	89 44 24 04          	mov    %eax,0x4(%esp)
8010534b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105352:	e8 09 f6 ff ff       	call   80104960 <argstr>
80105357:	85 c0                	test   %eax,%eax
80105359:	78 4a                	js     801053a5 <sys_chdir+0x75>
8010535b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010535e:	89 04 24             	mov    %eax,(%esp)
80105361:	e8 9a cb ff ff       	call   80101f00 <namei>
80105366:	85 c0                	test   %eax,%eax
80105368:	89 c3                	mov    %eax,%ebx
8010536a:	74 39                	je     801053a5 <sys_chdir+0x75>
    end_op();
    return -1;
  }
  ilock(ip);
8010536c:	89 04 24             	mov    %eax,(%esp)
8010536f:	e8 3c c3 ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
80105374:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
    iunlockput(ip);
80105379:	89 1c 24             	mov    %ebx,(%esp)
  if(ip->type != T_DIR){
8010537c:	75 22                	jne    801053a0 <sys_chdir+0x70>
    end_op();
    return -1;
  }
  iunlock(ip);
8010537e:	e8 0d c4 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80105383:	8b 46 68             	mov    0x68(%esi),%eax
80105386:	89 04 24             	mov    %eax,(%esp)
80105389:	e8 42 c4 ff ff       	call   801017d0 <iput>
  end_op();
8010538e:	e8 ed d7 ff ff       	call   80102b80 <end_op>
  curproc->cwd = ip;
  return 0;
80105393:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
80105395:	89 5e 68             	mov    %ebx,0x68(%esi)
}
80105398:	83 c4 20             	add    $0x20,%esp
8010539b:	5b                   	pop    %ebx
8010539c:	5e                   	pop    %esi
8010539d:	5d                   	pop    %ebp
8010539e:	c3                   	ret    
8010539f:	90                   	nop
    iunlockput(ip);
801053a0:	e8 6b c5 ff ff       	call   80101910 <iunlockput>
    end_op();
801053a5:	e8 d6 d7 ff ff       	call   80102b80 <end_op>
}
801053aa:	83 c4 20             	add    $0x20,%esp
    return -1;
...
801053c6:	81 ec ac 00 00 00    	sub    $0xac,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
801053cc:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
801053d2:	89 44 24 04          	mov    %eax,0x4(%esp)
801053d6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801053dd:	e8 7e f5 ff ff       	call   80104960 <argstr>
801053e2:	85 c0                	test   %eax,%eax
801053e4:	0f 88 84 00 00 00    	js     8010546e <sys_exec+0xae>
801053ea:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
801053f0:	89 44 24 04          	mov    %eax,0x4(%esp)
801053f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801053fb:	e8 d0 f4 ff ff       	call   801048d0 <argint>
80105400:	85 c0                	test   %eax,%eax
80105402:	78 6a                	js     8010546e <sys_exec+0xae>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105404:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
8010540a:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
8010540c:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80105413:	00 
80105414:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
8010541a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105421:	00 
80105422:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105428:	89 04 24             	mov    %eax,(%esp)
8010542b:	e8 b0 f1 ff ff       	call   801045e0 <memset>
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105430:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105436:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010543a:	8d 04 98             	lea    (%eax,%ebx,4),%eax
8010543d:	89 04 24             	mov    %eax,(%esp)
80105440:	e8 eb f3 ff ff       	call   80104830 <fetchint>
80105445:	85 c0                	test   %eax,%eax
80105447:	78 25                	js     8010546e <sys_exec+0xae>
      return -1;
    if(uarg == 0){
80105449:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
8010544f:	85 c0                	test   %eax,%eax
80105451:	74 2d                	je     80105480 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80105453:	89 74 24 04          	mov    %esi,0x4(%esp)
80105457:	89 04 24             	mov    %eax,(%esp)
8010545a:	e8 11 f4 ff ff       	call   80104870 <fetchstr>
8010545f:	85 c0                	test   %eax,%eax
80105461:	78 0b                	js     8010546e <sys_exec+0xae>
  for(i=0;; i++){
80105463:	83 c3 01             	add    $0x1,%ebx
80105466:	83 c6 04             	add    $0x4,%esi
    if(i >= NELEM(argv))
80105469:	83 fb 20             	cmp    $0x20,%ebx
8010546c:	75 c2                	jne    80105430 <sys_exec+0x70>
      return -1;
  }
  return exec(path, argv);
}
8010546e:	81 c4 ac 00 00 00    	add    $0xac,%esp
    return -1;
...
8010548a:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
      argv[i] = 0;
80105490:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80105497:	00 00 00 00 
  return exec(path, argv);
8010549b:	89 04 24             	mov    %eax,(%esp)
8010549e:	e8 fd b4 ff ff       	call   801009a0 <exec>
}
801054a3:	81 c4 ac 00 00 00    	add    $0xac,%esp
801054a9:	5b                   	pop    %ebx
801054aa:	5e                   	pop    %esi
801054ab:	5f                   	pop    %edi
801054ac:	5d                   	pop    %ebp
...
801054b7:	8d 45 ec             	lea    -0x14(%ebp),%eax
801054ba:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801054c1:	00 
801054c2:	89 44 24 04          	mov    %eax,0x4(%esp)
801054c6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801054cd:	e8 2e f4 ff ff       	call   80104900 <argptr>
801054d2:	85 c0                	test   %eax,%eax
801054d4:	78 6d                	js     80105543 <sys_pipe+0x93>
    return -1;
...
801054e3:	e8 88 dc ff ff       	call   80103170 <pipealloc>
801054e8:	85 c0                	test   %eax,%eax
801054ea:	78 57                	js     80105543 <sys_pipe+0x93>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801054ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801054ef:	e8 1c f5 ff ff       	call   80104a10 <fdalloc>
801054f4:	85 c0                	test   %eax,%eax
801054f6:	89 c3                	mov    %eax,%ebx
801054f8:	78 33                	js     8010552d <sys_pipe+0x7d>
801054fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054fd:	e8 0e f5 ff ff       	call   80104a10 <fdalloc>
80105502:	85 c0                	test   %eax,%eax
80105504:	78 1a                	js     80105520 <sys_pipe+0x70>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
80105509:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
8010550b:	8b 55 ec             	mov    -0x14(%ebp),%edx
...
80105519:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105520:	e8 7b e1 ff ff       	call   801036a0 <myproc>
80105525:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
8010552c:	00 
    fileclose(rf);
8010552d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105530:	89 04 24             	mov    %eax,(%esp)
80105533:	e8 f8 b8 ff ff       	call   80100e30 <fileclose>
    fileclose(wf);
80105538:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010553b:	89 04 24             	mov    %eax,(%esp)
8010553e:	e8 ed b8 ff ff       	call   80100e30 <fileclose>
}
80105543:	83 c4 24             	add    $0x24,%esp
    return -1;
...
80105553:	5d                   	pop    %ebp
  return fork();
80105554:	e9 f7 e2 ff ff       	jmp    80103850 <fork>
80105559:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105560 <sys_exit>:

int
sys_exit(void) //Changed the exit call signature
{
80105560:	55                   	push   %ebp
80105561:	89 e5                	mov    %esp,%ebp
80105563:	83 ec 08             	sub    $0x8,%esp
  exit(); 
80105566:	e8 35 e5 ff ff       	call   80103aa0 <exit>
...
80105584:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  if(argint(n, &status) < 0)
8010558b:	e8 40 f3 ff ff       	call   801048d0 <argint>
80105590:	85 c0                	test   %eax,%eax
80105592:	78 14                	js     801055a8 <sys_exitS+0x38>
    return -1; //no arg then return -1

  exitS(status);
80105594:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105597:	89 04 24             	mov    %eax,(%esp)
8010559a:	e8 21 e6 ff ff       	call   80103bc0 <exitS>
  return 0;
...
801055b3:	5d                   	pop    %ebp
  return wait();
801055b4:	e9 17 e8 ff ff       	jmp    80103dd0 <wait>
...
801055c3:	83 ec 28             	sub    $0x28,%esp
  int *status = 0;
  int n = 0;
  if(argptr(n, (void *)&status,sizeof(*status)) < 0)
801055c6:	8d 45 f4             	lea    -0xc(%ebp),%eax
801055c9:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801055d0:	00 
801055d1:	89 44 24 04          	mov    %eax,0x4(%esp)
801055d5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  int *status = 0;
801055dc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  if(argptr(n, (void *)&status,sizeof(*status)) < 0)
801055e3:	e8 18 f3 ff ff       	call   80104900 <argptr>
801055e8:	85 c0                	test   %eax,%eax
801055ea:	78 14                	js     80105600 <sys_waitS+0x40>
    return -1; //if no child exists return -1.

  return waitS(status);
801055ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055ef:	89 04 24             	mov    %eax,(%esp)
801055f2:	e8 b9 e8 ff ff       	call   80103eb0 <waitS>
}
801055f7:	c9                   	leave  
801055f8:	c3                   	ret    
...
int
sys_waitpid(void) //int waitpid(int pid 0, int *status (1), int options (2))
{
...
80105613:	83 ec 28             	sub    $0x28,%esp
  ...
  //this is where the return -1 scenarios go
  //for status
...
80105624:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  if((argint(0, &pid) < 0) || (argptr(1, (void *)&status, sizeof(*status)) < 0) || (argint(2, &options) < 0))
8010562b:	e8 a0 f2 ff ff       	call   801048d0 <argint>
80105630:	85 c0                	test   %eax,%eax
80105632:	78 54                	js     80105688 <sys_waitpid+0x78>
80105634:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105637:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
8010563e:	00 
8010563f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105643:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010564a:	e8 b1 f2 ff ff       	call   80104900 <argptr>
8010564f:	85 c0                	test   %eax,%eax
80105651:	78 35                	js     80105688 <sys_waitpid+0x78>
80105653:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105656:	89 44 24 04          	mov    %eax,0x4(%esp)
8010565a:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105661:	e8 6a f2 ff ff       	call   801048d0 <argint>
80105666:	85 c0                	test   %eax,%eax
80105668:	78 1e                	js     80105688 <sys_waitpid+0x78>
    return -1;
...
8010567e:	e8 1d e9 ff ff       	call   80103fa0 <waitpid>
...
801056a4:	e8 27 f2 ff ff       	call   801048d0 <argint>
801056a9:	85 c0                	test   %eax,%eax
801056ab:	78 13                	js     801056c0 <sys_kill+0x30>
    return -1;
  return kill(pid);
801056ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801056b0:	89 04 24             	mov    %eax,(%esp)
801056b3:	e8 78 ea ff ff       	call   80104130 <kill>
}
801056b8:	c9                   	leave  
801056b9:	c3                   	ret    
...
801056d3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801056d6:	e8 c5 df ff ff       	call   801036a0 <myproc>
...
801056e4:	83 ec 24             	sub    $0x24,%esp
  int addr;
  int n;
...
801056ee:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801056f5:	e8 d6 f1 ff ff       	call   801048d0 <argint>
801056fa:	85 c0                	test   %eax,%eax
801056fc:	78 22                	js     80105720 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801056fe:	e8 9d df ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
80105703:	8b 55 f4             	mov    -0xc(%ebp),%edx
  addr = myproc()->sz;
80105706:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105708:	89 14 24             	mov    %edx,(%esp)
8010570b:	e8 d0 e0 ff ff       	call   801037e0 <growproc>
80105710:	85 c0                	test   %eax,%eax
80105712:	78 0c                	js     80105720 <sys_sbrk+0x40>
    return -1;
  return addr;
...
80105725:	eb ef                	jmp    80105716 <sys_sbrk+0x36>
...
80105734:	83 ec 24             	sub    $0x24,%esp
  int n;
  uint ticks0;
...
80105745:	e8 86 f1 ff ff       	call   801048d0 <argint>
8010574a:	85 c0                	test   %eax,%eax
8010574c:	78 7e                	js     801057cc <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010574e:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105755:	e8 c6 ed ff ff       	call   80104520 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010575a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010575d:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
80105763:	85 d2                	test   %edx,%edx
80105765:	75 29                	jne    80105790 <sys_sleep+0x60>
80105767:	eb 4f                	jmp    801057b8 <sys_sleep+0x88>
...
80105770:	c7 44 24 04 60 4d 11 	movl   $0x80114d60,0x4(%esp)
80105777:	80 
80105778:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
8010577f:	e8 9c e5 ff ff       	call   80103d20 <sleep>
  while(ticks - ticks0 < n){
80105784:	a1 a0 55 11 80       	mov    0x801155a0,%eax
80105789:	29 d8                	sub    %ebx,%eax
8010578b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
8010578e:	73 28                	jae    801057b8 <sys_sleep+0x88>
    if(myproc()->killed){
80105790:	e8 0b df ff ff       	call   801036a0 <myproc>
80105795:	8b 40 24             	mov    0x24(%eax),%eax
80105798:	85 c0                	test   %eax,%eax
8010579a:	74 d4                	je     80105770 <sys_sleep+0x40>
      release(&tickslock);
8010579c:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801057a3:	e8 e8 ed ff ff       	call   80104590 <release>
      return -1;
...
801057ad:	83 c4 24             	add    $0x24,%esp
801057b0:	5b                   	pop    %ebx
801057b1:	5d                   	pop    %ebp
801057b2:	c3                   	ret    
801057b3:	90                   	nop
801057b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
801057b8:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801057bf:	e8 cc ed ff ff       	call   80104590 <release>
}
801057c4:	83 c4 24             	add    $0x24,%esp
  return 0;
...
801057d1:	eb da                	jmp    801057ad <sys_sleep+0x7d>
...
801057e4:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
801057e7:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801057ee:	e8 2d ed ff ff       	call   80104520 <acquire>
  xticks = ticks;
801057f3:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
801057f9:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105800:	e8 8b ed ff ff       	call   80104590 <release>
  return xticks;
}
80105805:	83 c4 14             	add    $0x14,%esp
...
8010580e:	06                   	push   %es
  pushl %fs
8010580f:	0f a0                	push   %fs
  pushl %gs
80105811:	0f a8                	push   %gs
  pushal
80105813:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105814:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105818:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010581a:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010581c:	54                   	push   %esp
  call trap
8010581d:	e8 de 00 00 00       	call   80105900 <trap>
  addl $4, %esp
80105822:	83 c4 04             	add    $0x4,%esp
...
80105825:	61                   	popa   
  popl %gs
80105826:	0f a9                	pop    %gs
  popl %fs
80105828:	0f a1                	pop    %fs
  popl %es
8010582a:	07                   	pop    %es
  popl %ds
8010582b:	1f                   	pop    %ds
...
80105844:	66 89 0c c5 a2 4d 11 	mov    %cx,-0x7feeb25e(,%eax,8)
8010584b:	80 
8010584c:	c6 04 c5 a4 4d 11 80 	movb   $0x0,-0x7feeb25c(,%eax,8)
80105853:	00 
...
80105890:	80 
80105891:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105898:	66 89 15 a2 4f 11 80 	mov    %dx,0x80114fa2
8010589f:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
801058a5:	c1 e8 10             	shr    $0x10,%eax
801058a8:	c6 05 a4 4f 11 80 00 	movb   $0x0,0x80114fa4
801058af:	c6 05 a5 4f 11 80 ef 	movb   $0xef,0x80114fa5
801058b6:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
801058bc:	e8 ef ea ff ff       	call   801043b0 <initlock>
}
801058c1:	c9                   	leave  
801058c2:	c3                   	ret    
...
80105a1b:	75 a8                	jne    801059c5 <trap+0xc5>
    exit();
80105a1d:	e8 7e e0 ff ff       	call   80103aa0 <exit>
...
80105a30:	75 a9                	jne    801059db <trap+0xdb>
    yield();
80105a32:	e8 a9 e2 ff ff       	call   80103ce0 <yield>
...
80105ad1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105ad4:	e8 c7 ee ff ff       	call   801049a0 <syscall>
    if(myproc()->killed)
...
80105aef:	5d                   	pop    %ebp
      exit();
80105af0:	e9 ab df ff ff       	jmp    80103aa0 <exit>
80105af5:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105af8:	e8 a3 df ff ff       	call   80103aa0 <exit>
80105afd:	eb cd                	jmp    80105acc <trap+0x1cc>
80105aff:	90                   	nop
      acquire(&tickslock);
80105b00:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105b07:	e8 14 ea ff ff       	call   80104520 <acquire>
      wakeup(&ticks);
80105b0c:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105b13:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105b1a:	e8 b1 e5 ff ff       	call   801040d0 <wakeup>
      release(&tickslock);
80105b1f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105b26:	e8 65 ea ff ff       	call   80104590 <release>
...
80105ca6:	6a 00                	push   $0x0
  jmp alltraps
80105ca8:	e9 60 fb ff ff       	jmp    8010580d <alltraps>
...
80105caf:	6a 01                	push   $0x1
  jmp alltraps
80105cb1:	e9 57 fb ff ff       	jmp    8010580d <alltraps>
...
80105cb8:	6a 02                	push   $0x2
  jmp alltraps
80105cba:	e9 4e fb ff ff       	jmp    8010580d <alltraps>
...
80105cc1:	6a 03                	push   $0x3
  jmp alltraps
80105cc3:	e9 45 fb ff ff       	jmp    8010580d <alltraps>
...
80105cca:	6a 04                	push   $0x4
  jmp alltraps
80105ccc:	e9 3c fb ff ff       	jmp    8010580d <alltraps>
...
80105cd3:	6a 05                	push   $0x5
  jmp alltraps
80105cd5:	e9 33 fb ff ff       	jmp    8010580d <alltraps>
...
80105cdc:	6a 06                	push   $0x6
  jmp alltraps
80105cde:	e9 2a fb ff ff       	jmp    8010580d <alltraps>
...
80105ce5:	6a 07                	push   $0x7
  jmp alltraps
80105ce7:	e9 21 fb ff ff       	jmp    8010580d <alltraps>
...
80105cec:	6a 08                	push   $0x8
  jmp alltraps
80105cee:	e9 1a fb ff ff       	jmp    8010580d <alltraps>
...
80105cf5:	6a 09                	push   $0x9
  jmp alltraps
80105cf7:	e9 11 fb ff ff       	jmp    8010580d <alltraps>
...
80105cfc:	6a 0a                	push   $0xa
  jmp alltraps
80105cfe:	e9 0a fb ff ff       	jmp    8010580d <alltraps>
...
80105d03:	6a 0b                	push   $0xb
  jmp alltraps
80105d05:	e9 03 fb ff ff       	jmp    8010580d <alltraps>
...
80105d0a:	6a 0c                	push   $0xc
  jmp alltraps
80105d0c:	e9 fc fa ff ff       	jmp    8010580d <alltraps>
...
80105d11:	6a 0d                	push   $0xd
  jmp alltraps
80105d13:	e9 f5 fa ff ff       	jmp    8010580d <alltraps>
...
80105d18:	6a 0e                	push   $0xe
  jmp alltraps
80105d1a:	e9 ee fa ff ff       	jmp    8010580d <alltraps>
...
80105d21:	6a 0f                	push   $0xf
  jmp alltraps
80105d23:	e9 e5 fa ff ff       	jmp    8010580d <alltraps>
...
80105d2a:	6a 10                	push   $0x10
  jmp alltraps
80105d2c:	e9 dc fa ff ff       	jmp    8010580d <alltraps>
...
80105d31:	6a 11                	push   $0x11
  jmp alltraps
80105d33:	e9 d5 fa ff ff       	jmp    8010580d <alltraps>
...
80105d3a:	6a 12                	push   $0x12
  jmp alltraps
80105d3c:	e9 cc fa ff ff       	jmp    8010580d <alltraps>
...
80105d43:	6a 13                	push   $0x13
  jmp alltraps
80105d45:	e9 c3 fa ff ff       	jmp    8010580d <alltraps>
...
80105d4c:	6a 14                	push   $0x14
  jmp alltraps
80105d4e:	e9 ba fa ff ff       	jmp    8010580d <alltraps>
...
80105d55:	6a 15                	push   $0x15
  jmp alltraps
80105d57:	e9 b1 fa ff ff       	jmp    8010580d <alltraps>
...
80105d5e:	6a 16                	push   $0x16
  jmp alltraps
80105d60:	e9 a8 fa ff ff       	jmp    8010580d <alltraps>
...
80105d67:	6a 17                	push   $0x17
  jmp alltraps
80105d69:	e9 9f fa ff ff       	jmp    8010580d <alltraps>
...
80105d70:	6a 18                	push   $0x18
  jmp alltraps
80105d72:	e9 96 fa ff ff       	jmp    8010580d <alltraps>
...
80105d79:	6a 19                	push   $0x19
  jmp alltraps
80105d7b:	e9 8d fa ff ff       	jmp    8010580d <alltraps>
...
80105d82:	6a 1a                	push   $0x1a
  jmp alltraps
80105d84:	e9 84 fa ff ff       	jmp    8010580d <alltraps>
...
80105d8b:	6a 1b                	push   $0x1b
  jmp alltraps
80105d8d:	e9 7b fa ff ff       	jmp    8010580d <alltraps>
...
80105d94:	6a 1c                	push   $0x1c
  jmp alltraps
80105d96:	e9 72 fa ff ff       	jmp    8010580d <alltraps>
...
80105d9d:	6a 1d                	push   $0x1d
  jmp alltraps
80105d9f:	e9 69 fa ff ff       	jmp    8010580d <alltraps>
...
80105da6:	6a 1e                	push   $0x1e
  jmp alltraps
80105da8:	e9 60 fa ff ff       	jmp    8010580d <alltraps>
...
80105daf:	6a 1f                	push   $0x1f
  jmp alltraps
80105db1:	e9 57 fa ff ff       	jmp    8010580d <alltraps>
...
80105db8:	6a 20                	push   $0x20
  jmp alltraps
80105dba:	e9 4e fa ff ff       	jmp    8010580d <alltraps>
...
80105dc1:	6a 21                	push   $0x21
  jmp alltraps
80105dc3:	e9 45 fa ff ff       	jmp    8010580d <alltraps>
...
80105dca:	6a 22                	push   $0x22
  jmp alltraps
80105dcc:	e9 3c fa ff ff       	jmp    8010580d <alltraps>
...
80105dd3:	6a 23                	push   $0x23
  jmp alltraps
80105dd5:	e9 33 fa ff ff       	jmp    8010580d <alltraps>
...
80105ddc:	6a 24                	push   $0x24
  jmp alltraps
80105dde:	e9 2a fa ff ff       	jmp    8010580d <alltraps>
...
80105de5:	6a 25                	push   $0x25
  jmp alltraps
80105de7:	e9 21 fa ff ff       	jmp    8010580d <alltraps>
...
80105dee:	6a 26                	push   $0x26
  jmp alltraps
80105df0:	e9 18 fa ff ff       	jmp    8010580d <alltraps>
...
80105df7:	6a 27                	push   $0x27
  jmp alltraps
80105df9:	e9 0f fa ff ff       	jmp    8010580d <alltraps>
...
80105e00:	6a 28                	push   $0x28
  jmp alltraps
80105e02:	e9 06 fa ff ff       	jmp    8010580d <alltraps>
...
80105e09:	6a 29                	push   $0x29
  jmp alltraps
80105e0b:	e9 fd f9 ff ff       	jmp    8010580d <alltraps>
...
80105e12:	6a 2a                	push   $0x2a
  jmp alltraps
80105e14:	e9 f4 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e1b:	6a 2b                	push   $0x2b
  jmp alltraps
80105e1d:	e9 eb f9 ff ff       	jmp    8010580d <alltraps>
...
80105e24:	6a 2c                	push   $0x2c
  jmp alltraps
80105e26:	e9 e2 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e2d:	6a 2d                	push   $0x2d
  jmp alltraps
80105e2f:	e9 d9 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e36:	6a 2e                	push   $0x2e
  jmp alltraps
80105e38:	e9 d0 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e3f:	6a 2f                	push   $0x2f
  jmp alltraps
80105e41:	e9 c7 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e48:	6a 30                	push   $0x30
  jmp alltraps
80105e4a:	e9 be f9 ff ff       	jmp    8010580d <alltraps>
...
80105e51:	6a 31                	push   $0x31
  jmp alltraps
80105e53:	e9 b5 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e5a:	6a 32                	push   $0x32
  jmp alltraps
80105e5c:	e9 ac f9 ff ff       	jmp    8010580d <alltraps>
...
80105e63:	6a 33                	push   $0x33
  jmp alltraps
80105e65:	e9 a3 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e6c:	6a 34                	push   $0x34
  jmp alltraps
80105e6e:	e9 9a f9 ff ff       	jmp    8010580d <alltraps>
...
80105e75:	6a 35                	push   $0x35
  jmp alltraps
80105e77:	e9 91 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e7e:	6a 36                	push   $0x36
  jmp alltraps
80105e80:	e9 88 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e87:	6a 37                	push   $0x37
  jmp alltraps
80105e89:	e9 7f f9 ff ff       	jmp    8010580d <alltraps>
...
80105e90:	6a 38                	push   $0x38
  jmp alltraps
80105e92:	e9 76 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e99:	6a 39                	push   $0x39
  jmp alltraps
80105e9b:	e9 6d f9 ff ff       	jmp    8010580d <alltraps>
...
80105ea2:	6a 3a                	push   $0x3a
  jmp alltraps
80105ea4:	e9 64 f9 ff ff       	jmp    8010580d <alltraps>
...
80105eab:	6a 3b                	push   $0x3b
  jmp alltraps
80105ead:	e9 5b f9 ff ff       	jmp    8010580d <alltraps>
...
80105eb4:	6a 3c                	push   $0x3c
  jmp alltraps
80105eb6:	e9 52 f9 ff ff       	jmp    8010580d <alltraps>
...
80105ebd:	6a 3d                	push   $0x3d
  jmp alltraps
80105ebf:	e9 49 f9 ff ff       	jmp    8010580d <alltraps>
...
80105ec6:	6a 3e                	push   $0x3e
  jmp alltraps
80105ec8:	e9 40 f9 ff ff       	jmp    8010580d <alltraps>
...
80105ecf:	6a 3f                	push   $0x3f
  jmp alltraps
80105ed1:	e9 37 f9 ff ff       	jmp    8010580d <alltraps>
...
80105ed8:	6a 40                	push   $0x40
  jmp alltraps
80105eda:	e9 2e f9 ff ff       	jmp    8010580d <alltraps>
...
80105ee1:	6a 41                	push   $0x41
  jmp alltraps
80105ee3:	e9 25 f9 ff ff       	jmp    8010580d <alltraps>
...
80105eea:	6a 42                	push   $0x42
  jmp alltraps
80105eec:	e9 1c f9 ff ff       	jmp    8010580d <alltraps>
...
80105ef3:	6a 43                	push   $0x43
  jmp alltraps
80105ef5:	e9 13 f9 ff ff       	jmp    8010580d <alltraps>
...
80105efc:	6a 44                	push   $0x44
  jmp alltraps
80105efe:	e9 0a f9 ff ff       	jmp    8010580d <alltraps>
...
80105f05:	6a 45                	push   $0x45
  jmp alltraps
80105f07:	e9 01 f9 ff ff       	jmp    8010580d <alltraps>
...
80105f0e:	6a 46                	push   $0x46
  jmp alltraps
80105f10:	e9 f8 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f17:	6a 47                	push   $0x47
  jmp alltraps
80105f19:	e9 ef f8 ff ff       	jmp    8010580d <alltraps>
...
80105f20:	6a 48                	push   $0x48
  jmp alltraps
80105f22:	e9 e6 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f29:	6a 49                	push   $0x49
  jmp alltraps
80105f2b:	e9 dd f8 ff ff       	jmp    8010580d <alltraps>
...
80105f32:	6a 4a                	push   $0x4a
  jmp alltraps
80105f34:	e9 d4 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f3b:	6a 4b                	push   $0x4b
  jmp alltraps
80105f3d:	e9 cb f8 ff ff       	jmp    8010580d <alltraps>
...
80105f44:	6a 4c                	push   $0x4c
  jmp alltraps
80105f46:	e9 c2 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f4d:	6a 4d                	push   $0x4d
  jmp alltraps
80105f4f:	e9 b9 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f56:	6a 4e                	push   $0x4e
  jmp alltraps
80105f58:	e9 b0 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f5f:	6a 4f                	push   $0x4f
  jmp alltraps
80105f61:	e9 a7 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f68:	6a 50                	push   $0x50
  jmp alltraps
80105f6a:	e9 9e f8 ff ff       	jmp    8010580d <alltraps>
...
80105f71:	6a 51                	push   $0x51
  jmp alltraps
80105f73:	e9 95 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f7a:	6a 52                	push   $0x52
  jmp alltraps
80105f7c:	e9 8c f8 ff ff       	jmp    8010580d <alltraps>
...
80105f83:	6a 53                	push   $0x53
  jmp alltraps
80105f85:	e9 83 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f8c:	6a 54                	push   $0x54
  jmp alltraps
80105f8e:	e9 7a f8 ff ff       	jmp    8010580d <alltraps>
...
80105f95:	6a 55                	push   $0x55
  jmp alltraps
80105f97:	e9 71 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f9e:	6a 56                	push   $0x56
  jmp alltraps
80105fa0:	e9 68 f8 ff ff       	jmp    8010580d <alltraps>
...
80105fa7:	6a 57                	push   $0x57
  jmp alltraps
80105fa9:	e9 5f f8 ff ff       	jmp    8010580d <alltraps>
...
80105fb0:	6a 58                	push   $0x58
  jmp alltraps
80105fb2:	e9 56 f8 ff ff       	jmp    8010580d <alltraps>
...
80105fb9:	6a 59                	push   $0x59
  jmp alltraps
80105fbb:	e9 4d f8 ff ff       	jmp    8010580d <alltraps>
...
80105fc2:	6a 5a                	push   $0x5a
  jmp alltraps
80105fc4:	e9 44 f8 ff ff       	jmp    8010580d <alltraps>
...
80105fcb:	6a 5b                	push   $0x5b
  jmp alltraps
80105fcd:	e9 3b f8 ff ff       	jmp    8010580d <alltraps>
...
80105fd4:	6a 5c                	push   $0x5c
  jmp alltraps
80105fd6:	e9 32 f8 ff ff       	jmp    8010580d <alltraps>
...
80105fdd:	6a 5d                	push   $0x5d
  jmp alltraps
80105fdf:	e9 29 f8 ff ff       	jmp    8010580d <alltraps>
...
80105fe6:	6a 5e                	push   $0x5e
  jmp alltraps
80105fe8:	e9 20 f8 ff ff       	jmp    8010580d <alltraps>
...
80105fef:	6a 5f                	push   $0x5f
  jmp alltraps
80105ff1:	e9 17 f8 ff ff       	jmp    8010580d <alltraps>
...
80105ff8:	6a 60                	push   $0x60
  jmp alltraps
80105ffa:	e9 0e f8 ff ff       	jmp    8010580d <alltraps>
...
80106001:	6a 61                	push   $0x61
  jmp alltraps
80106003:	e9 05 f8 ff ff       	jmp    8010580d <alltraps>
...
8010600a:	6a 62                	push   $0x62
  jmp alltraps
8010600c:	e9 fc f7 ff ff       	jmp    8010580d <alltraps>
...
80106013:	6a 63                	push   $0x63
  jmp alltraps
80106015:	e9 f3 f7 ff ff       	jmp    8010580d <alltraps>
...
8010601c:	6a 64                	push   $0x64
  jmp alltraps
8010601e:	e9 ea f7 ff ff       	jmp    8010580d <alltraps>
...
80106025:	6a 65                	push   $0x65
  jmp alltraps
80106027:	e9 e1 f7 ff ff       	jmp    8010580d <alltraps>
...
8010602e:	6a 66                	push   $0x66
  jmp alltraps
80106030:	e9 d8 f7 ff ff       	jmp    8010580d <alltraps>
...
80106037:	6a 67                	push   $0x67
  jmp alltraps
80106039:	e9 cf f7 ff ff       	jmp    8010580d <alltraps>
...
80106040:	6a 68                	push   $0x68
  jmp alltraps
80106042:	e9 c6 f7 ff ff       	jmp    8010580d <alltraps>
...
80106049:	6a 69                	push   $0x69
  jmp alltraps
8010604b:	e9 bd f7 ff ff       	jmp    8010580d <alltraps>
...
80106052:	6a 6a                	push   $0x6a
  jmp alltraps
80106054:	e9 b4 f7 ff ff       	jmp    8010580d <alltraps>
...
8010605b:	6a 6b                	push   $0x6b
  jmp alltraps
8010605d:	e9 ab f7 ff ff       	jmp    8010580d <alltraps>
...
80106064:	6a 6c                	push   $0x6c
  jmp alltraps
80106066:	e9 a2 f7 ff ff       	jmp    8010580d <alltraps>
...
8010606d:	6a 6d                	push   $0x6d
  jmp alltraps
8010606f:	e9 99 f7 ff ff       	jmp    8010580d <alltraps>
...
80106076:	6a 6e                	push   $0x6e
  jmp alltraps
80106078:	e9 90 f7 ff ff       	jmp    8010580d <alltraps>
...
8010607f:	6a 6f                	push   $0x6f
  jmp alltraps
80106081:	e9 87 f7 ff ff       	jmp    8010580d <alltraps>
...
80106088:	6a 70                	push   $0x70
  jmp alltraps
8010608a:	e9 7e f7 ff ff       	jmp    8010580d <alltraps>
...
80106091:	6a 71                	push   $0x71
  jmp alltraps
80106093:	e9 75 f7 ff ff       	jmp    8010580d <alltraps>
...
8010609a:	6a 72                	push   $0x72
  jmp alltraps
8010609c:	e9 6c f7 ff ff       	jmp    8010580d <alltraps>
...
801060a3:	6a 73                	push   $0x73
  jmp alltraps
801060a5:	e9 63 f7 ff ff       	jmp    8010580d <alltraps>
...
801060ac:	6a 74                	push   $0x74
  jmp alltraps
801060ae:	e9 5a f7 ff ff       	jmp    8010580d <alltraps>
...
801060b5:	6a 75                	push   $0x75
  jmp alltraps
801060b7:	e9 51 f7 ff ff       	jmp    8010580d <alltraps>
...
801060be:	6a 76                	push   $0x76
  jmp alltraps
801060c0:	e9 48 f7 ff ff       	jmp    8010580d <alltraps>
...
801060c7:	6a 77                	push   $0x77
  jmp alltraps
801060c9:	e9 3f f7 ff ff       	jmp    8010580d <alltraps>
...
801060d0:	6a 78                	push   $0x78
  jmp alltraps
801060d2:	e9 36 f7 ff ff       	jmp    8010580d <alltraps>
...
801060d9:	6a 79                	push   $0x79
  jmp alltraps
801060db:	e9 2d f7 ff ff       	jmp    8010580d <alltraps>
...
801060e2:	6a 7a                	push   $0x7a
  jmp alltraps
801060e4:	e9 24 f7 ff ff       	jmp    8010580d <alltraps>
...
801060eb:	6a 7b                	push   $0x7b
  jmp alltraps
801060ed:	e9 1b f7 ff ff       	jmp    8010580d <alltraps>
...
801060f4:	6a 7c                	push   $0x7c
  jmp alltraps
801060f6:	e9 12 f7 ff ff       	jmp    8010580d <alltraps>
...
801060fd:	6a 7d                	push   $0x7d
  jmp alltraps
801060ff:	e9 09 f7 ff ff       	jmp    8010580d <alltraps>
...
80106106:	6a 7e                	push   $0x7e
  jmp alltraps
80106108:	e9 00 f7 ff ff       	jmp    8010580d <alltraps>
...
8010610f:	6a 7f                	push   $0x7f
  jmp alltraps
80106111:	e9 f7 f6 ff ff       	jmp    8010580d <alltraps>
...
80106118:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010611d:	e9 eb f6 ff ff       	jmp    8010580d <alltraps>
...
80106124:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106129:	e9 df f6 ff ff       	jmp    8010580d <alltraps>
...
80106130:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106135:	e9 d3 f6 ff ff       	jmp    8010580d <alltraps>
...
8010613c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106141:	e9 c7 f6 ff ff       	jmp    8010580d <alltraps>
...
80106148:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010614d:	e9 bb f6 ff ff       	jmp    8010580d <alltraps>
...
80106154:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106159:	e9 af f6 ff ff       	jmp    8010580d <alltraps>
...
80106160:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106165:	e9 a3 f6 ff ff       	jmp    8010580d <alltraps>
...
8010616c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106171:	e9 97 f6 ff ff       	jmp    8010580d <alltraps>
...
80106178:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010617d:	e9 8b f6 ff ff       	jmp    8010580d <alltraps>
...
80106184:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106189:	e9 7f f6 ff ff       	jmp    8010580d <alltraps>
...
80106190:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106195:	e9 73 f6 ff ff       	jmp    8010580d <alltraps>
...
8010619c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801061a1:	e9 67 f6 ff ff       	jmp    8010580d <alltraps>
...
801061a8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801061ad:	e9 5b f6 ff ff       	jmp    8010580d <alltraps>
...
801061b4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801061b9:	e9 4f f6 ff ff       	jmp    8010580d <alltraps>
...
801061c0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801061c5:	e9 43 f6 ff ff       	jmp    8010580d <alltraps>
...
801061cc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801061d1:	e9 37 f6 ff ff       	jmp    8010580d <alltraps>
...
801061d8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801061dd:	e9 2b f6 ff ff       	jmp    8010580d <alltraps>
...
801061e4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801061e9:	e9 1f f6 ff ff       	jmp    8010580d <alltraps>
...
801061f0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801061f5:	e9 13 f6 ff ff       	jmp    8010580d <alltraps>
...
801061fc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106201:	e9 07 f6 ff ff       	jmp    8010580d <alltraps>
...
80106208:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010620d:	e9 fb f5 ff ff       	jmp    8010580d <alltraps>
...
80106214:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106219:	e9 ef f5 ff ff       	jmp    8010580d <alltraps>
...
80106220:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106225:	e9 e3 f5 ff ff       	jmp    8010580d <alltraps>
...
8010622c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106231:	e9 d7 f5 ff ff       	jmp    8010580d <alltraps>
...
80106238:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010623d:	e9 cb f5 ff ff       	jmp    8010580d <alltraps>
...
80106244:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106249:	e9 bf f5 ff ff       	jmp    8010580d <alltraps>
...
80106250:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106255:	e9 b3 f5 ff ff       	jmp    8010580d <alltraps>
...
8010625c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106261:	e9 a7 f5 ff ff       	jmp    8010580d <alltraps>
...
80106268:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010626d:	e9 9b f5 ff ff       	jmp    8010580d <alltraps>
...
80106274:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106279:	e9 8f f5 ff ff       	jmp    8010580d <alltraps>
...
80106280:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106285:	e9 83 f5 ff ff       	jmp    8010580d <alltraps>
...
8010628c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106291:	e9 77 f5 ff ff       	jmp    8010580d <alltraps>
...
80106298:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010629d:	e9 6b f5 ff ff       	jmp    8010580d <alltraps>
...
801062a4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801062a9:	e9 5f f5 ff ff       	jmp    8010580d <alltraps>
...
801062b0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801062b5:	e9 53 f5 ff ff       	jmp    8010580d <alltraps>
...
801062bc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801062c1:	e9 47 f5 ff ff       	jmp    8010580d <alltraps>
...
801062c8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801062cd:	e9 3b f5 ff ff       	jmp    8010580d <alltraps>
...
801062d4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801062d9:	e9 2f f5 ff ff       	jmp    8010580d <alltraps>
...
801062e0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801062e5:	e9 23 f5 ff ff       	jmp    8010580d <alltraps>
...
801062ec:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801062f1:	e9 17 f5 ff ff       	jmp    8010580d <alltraps>
...
801062f8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801062fd:	e9 0b f5 ff ff       	jmp    8010580d <alltraps>
...
80106304:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106309:	e9 ff f4 ff ff       	jmp    8010580d <alltraps>
...
80106310:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106315:	e9 f3 f4 ff ff       	jmp    8010580d <alltraps>
...
8010631c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106321:	e9 e7 f4 ff ff       	jmp    8010580d <alltraps>
...
80106328:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010632d:	e9 db f4 ff ff       	jmp    8010580d <alltraps>
...
80106334:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106339:	e9 cf f4 ff ff       	jmp    8010580d <alltraps>
...
80106340:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106345:	e9 c3 f4 ff ff       	jmp    8010580d <alltraps>
...
8010634c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106351:	e9 b7 f4 ff ff       	jmp    8010580d <alltraps>
...
80106358:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010635d:	e9 ab f4 ff ff       	jmp    8010580d <alltraps>
...
80106364:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106369:	e9 9f f4 ff ff       	jmp    8010580d <alltraps>
...
80106370:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106375:	e9 93 f4 ff ff       	jmp    8010580d <alltraps>
...
8010637c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106381:	e9 87 f4 ff ff       	jmp    8010580d <alltraps>
...
80106388:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010638d:	e9 7b f4 ff ff       	jmp    8010580d <alltraps>
...
80106394:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106399:	e9 6f f4 ff ff       	jmp    8010580d <alltraps>
...
801063a0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801063a5:	e9 63 f4 ff ff       	jmp    8010580d <alltraps>
...
801063ac:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801063b1:	e9 57 f4 ff ff       	jmp    8010580d <alltraps>
...
801063b8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801063bd:	e9 4b f4 ff ff       	jmp    8010580d <alltraps>
...
801063c4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801063c9:	e9 3f f4 ff ff       	jmp    8010580d <alltraps>
...
801063d0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801063d5:	e9 33 f4 ff ff       	jmp    8010580d <alltraps>
...
801063dc:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801063e1:	e9 27 f4 ff ff       	jmp    8010580d <alltraps>
...
801063e8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801063ed:	e9 1b f4 ff ff       	jmp    8010580d <alltraps>
...
801063f4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801063f9:	e9 0f f4 ff ff       	jmp    8010580d <alltraps>
...
80106400:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106405:	e9 03 f4 ff ff       	jmp    8010580d <alltraps>
...
8010640c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106411:	e9 f7 f3 ff ff       	jmp    8010580d <alltraps>
...
80106418:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010641d:	e9 eb f3 ff ff       	jmp    8010580d <alltraps>
...
80106424:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106429:	e9 df f3 ff ff       	jmp    8010580d <alltraps>
...
80106430:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106435:	e9 d3 f3 ff ff       	jmp    8010580d <alltraps>
...
8010643c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106441:	e9 c7 f3 ff ff       	jmp    8010580d <alltraps>
...
80106448:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010644d:	e9 bb f3 ff ff       	jmp    8010580d <alltraps>
...
80106454:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106459:	e9 af f3 ff ff       	jmp    8010580d <alltraps>
...
80106460:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106465:	e9 a3 f3 ff ff       	jmp    8010580d <alltraps>
...
8010646c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106471:	e9 97 f3 ff ff       	jmp    8010580d <alltraps>
...
80106478:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010647d:	e9 8b f3 ff ff       	jmp    8010580d <alltraps>
...
80106484:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106489:	e9 7f f3 ff ff       	jmp    8010580d <alltraps>
...
80106490:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106495:	e9 73 f3 ff ff       	jmp    8010580d <alltraps>
...
8010649c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801064a1:	e9 67 f3 ff ff       	jmp    8010580d <alltraps>
...
801064a8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801064ad:	e9 5b f3 ff ff       	jmp    8010580d <alltraps>
...
801064b4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801064b9:	e9 4f f3 ff ff       	jmp    8010580d <alltraps>
...
801064c0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801064c5:	e9 43 f3 ff ff       	jmp    8010580d <alltraps>
...
801064cc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801064d1:	e9 37 f3 ff ff       	jmp    8010580d <alltraps>
...
801064d8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801064dd:	e9 2b f3 ff ff       	jmp    8010580d <alltraps>
...
801064e4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801064e9:	e9 1f f3 ff ff       	jmp    8010580d <alltraps>
...
801064f0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801064f5:	e9 13 f3 ff ff       	jmp    8010580d <alltraps>
...
801064fc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106501:	e9 07 f3 ff ff       	jmp    8010580d <alltraps>
...
80106508:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010650d:	e9 fb f2 ff ff       	jmp    8010580d <alltraps>
...
80106514:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106519:	e9 ef f2 ff ff       	jmp    8010580d <alltraps>
...
80106520:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106525:	e9 e3 f2 ff ff       	jmp    8010580d <alltraps>
...
8010652c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106531:	e9 d7 f2 ff ff       	jmp    8010580d <alltraps>
...
80106538:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010653d:	e9 cb f2 ff ff       	jmp    8010580d <alltraps>
...
80106544:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106549:	e9 bf f2 ff ff       	jmp    8010580d <alltraps>
...
80106550:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106555:	e9 b3 f2 ff ff       	jmp    8010580d <alltraps>
...
8010655c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106561:	e9 a7 f2 ff ff       	jmp    8010580d <alltraps>
...
80106568:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010656d:	e9 9b f2 ff ff       	jmp    8010580d <alltraps>
...
80106574:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106579:	e9 8f f2 ff ff       	jmp    8010580d <alltraps>
...
80106580:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106585:	e9 83 f2 ff ff       	jmp    8010580d <alltraps>
...
8010658c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106591:	e9 77 f2 ff ff       	jmp    8010580d <alltraps>
...
80106598:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010659d:	e9 6b f2 ff ff       	jmp    8010580d <alltraps>
...
801065a4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801065a9:	e9 5f f2 ff ff       	jmp    8010580d <alltraps>
...
801065b0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801065b5:	e9 53 f2 ff ff       	jmp    8010580d <alltraps>
...
801065bc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801065c1:	e9 47 f2 ff ff       	jmp    8010580d <alltraps>
...
801065c8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801065cd:	e9 3b f2 ff ff       	jmp    8010580d <alltraps>
...
801065d4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801065d9:	e9 2f f2 ff ff       	jmp    8010580d <alltraps>
...
801065e0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801065e5:	e9 23 f2 ff ff       	jmp    8010580d <alltraps>
...
801065ec:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801065f1:	e9 17 f2 ff ff       	jmp    8010580d <alltraps>
...
801065f8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801065fd:	e9 0b f2 ff ff       	jmp    8010580d <alltraps>
...
80106604:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106609:	e9 ff f1 ff ff       	jmp    8010580d <alltraps>
...
80106610:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106615:	e9 f3 f1 ff ff       	jmp    8010580d <alltraps>
...
8010661c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106621:	e9 e7 f1 ff ff       	jmp    8010580d <alltraps>
...
80106628:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010662d:	e9 db f1 ff ff       	jmp    8010580d <alltraps>
...
80106634:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106639:	e9 cf f1 ff ff       	jmp    8010580d <alltraps>
...
80106640:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106645:	e9 c3 f1 ff ff       	jmp    8010580d <alltraps>
...
8010664c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106651:	e9 b7 f1 ff ff       	jmp    8010580d <alltraps>
...
80106658:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010665d:	e9 ab f1 ff ff       	jmp    8010580d <alltraps>
...
80106664:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106669:	e9 9f f1 ff ff       	jmp    8010580d <alltraps>
...
80106670:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106675:	e9 93 f1 ff ff       	jmp    8010580d <alltraps>
...
8010667c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106681:	e9 87 f1 ff ff       	jmp    8010580d <alltraps>
...
80106688:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010668d:	e9 7b f1 ff ff       	jmp    8010580d <alltraps>
...
80106694:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106699:	e9 6f f1 ff ff       	jmp    8010580d <alltraps>
...
801066a0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801066a5:	e9 63 f1 ff ff       	jmp    8010580d <alltraps>
...
801066ac:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801066b1:	e9 57 f1 ff ff       	jmp    8010580d <alltraps>
...
801066b8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801066bd:	e9 4b f1 ff ff       	jmp    8010580d <alltraps>
...
801066c4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801066c9:	e9 3f f1 ff ff       	jmp    8010580d <alltraps>
...
801066d0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801066d5:	e9 33 f1 ff ff       	jmp    8010580d <alltraps>
...
801066dc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801066e1:	e9 27 f1 ff ff       	jmp    8010580d <alltraps>
...
801066e8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801066ed:	e9 1b f1 ff ff       	jmp    8010580d <alltraps>
...
801066f4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801066f9:	e9 0f f1 ff ff       	jmp    8010580d <alltraps>
...
80106700:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106705:	e9 03 f1 ff ff       	jmp    8010580d <alltraps>
...
8010670c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106711:	e9 f7 f0 ff ff       	jmp    8010580d <alltraps>
...
80106782:	e8 59 de ff ff       	call   801045e0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106990:	a1 a4 55 11 80       	mov    0x801155a4,%eax
{
...
801069d4:	0f 84 c3 00 00 00    	je     80106a9d <switchuvm+0xed>
  pushcli();
801069da:	e8 51 da ff ff       	call   80104430 <pushcli>
...
80106a8b:	5d                   	pop    %ebp
  popcli();
80106a8c:	e9 df d9 ff ff       	jmp    80104470 <popcli>
...
80106af7:	e8 e4 da ff ff       	call   801045e0 <memset>
...
80106b2b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b2c:	e9 4f db ff ff       	jmp    80104680 <memmove>
...
80106c43:	e8 98 d9 ff ff       	call   801045e0 <memset>
...
80106dbb:	e8 20 d8 ff ff       	call   801045e0 <memset>
...
80106ead:	e8 ce d7 ff ff       	call   80104680 <memmove>
...
80106fdc:	e8 9f d6 ff ff       	call   80104680 <memmove>
    len -= n;
    buf += n;
