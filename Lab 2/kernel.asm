...
801020bc:	e8 2f 1d 00 00       	call   80103df0 <wakeup>
...
80102c8a:	e8 61 11 00 00       	call   80103df0 <wakeup>
    release(&log.lock);
...
80102dd6:	e8 05 38 00 00       	call   801065e0 <switchkvm>
  seginit();
80102ddb:	e8 40 37 00 00       	call   80106520 <seginit>
  lapicinit();
...
80102e25:	e8 f6 36 00 00       	call   80106520 <seginit>
  picinit();       // disable pic
...
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 36 26 00 00       	call   80105480 <tvinit>
  binit();         // buffer cache
...
8010328d:	e8 5e 0b 00 00       	call   80103df0 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032cb:	e8 20 0b 00 00       	call   80103df0 <wakeup>
...
8010334f:	e8 9c 0a 00 00       	call   80103df0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
801033ca:	e8 21 0a 00 00       	call   80103df0 <wakeup>
  release(&p->lock);
...
801034a5:	e8 46 09 00 00       	call   80103df0 <wakeup>
  release(&p->lock);
...
801034f6:	a1 04 a0 10 80       	mov    0x8010a004,%eax
  p->priority = 10; //lab2 default priority
...
80103519:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
8010351c:	e8 8f 0d 00 00       	call   801042b0 <release>
...
80103538:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010353b:	c7 40 14 75 54 10 80 	movl   $0x80105475,0x14(%eax)
...
80103555:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103558:	e8 a3 0d 00 00       	call   80104300 <memset>
...
80103577:	e8 34 0d 00 00       	call   801042b0 <release>
}
...
80103809:	e8 42 30 00 00       	call   80106850 <allocuvm>
...
80103981:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
    highP = 32; //in case it is 32
80103988:	bf 20 00 00 00       	mov    $0x20,%edi
    acquire(&ptable.lock);
8010398d:	e8 ae 08 00 00       	call   80104240 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103992:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103997:	eb 11                	jmp    801039aa <scheduler+0x4a>
80103999:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801039a0:	83 e8 80             	sub    $0xffffff80,%eax
801039a3:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
801039a8:	74 18                	je     801039c2 <scheduler+0x62>
      if(p->state == RUNNABLE && p->priority < highP)
801039aa:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
801039ae:	75 f0                	jne    801039a0 <scheduler+0x40>
801039b0:	8b 48 7c             	mov    0x7c(%eax),%ecx
801039b3:	39 cf                	cmp    %ecx,%edi
801039b5:	0f 4f f9             	cmovg  %ecx,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039b8:	83 e8 80             	sub    $0xffffff80,%eax
801039bb:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
801039c0:	75 e8                	jne    801039aa <scheduler+0x4a>
801039c2:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
801039c7:	eb 12                	jmp    801039db <scheduler+0x7b>
...
801039d3:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
801039d9:	74 4d                	je     80103a28 <scheduler+0xc8>
      if(p->state != RUNNABLE || p->priority != highP) //If not runnable then cont
801039db:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
801039df:	75 ef                	jne    801039d0 <scheduler+0x70>
801039e1:	3b 7b 7c             	cmp    0x7c(%ebx),%edi
801039e4:	75 ea                	jne    801039d0 <scheduler+0x70>
      c->proc = p;
801039e6:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
801039ec:	89 1c 24             	mov    %ebx,(%esp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){ //right now it goes in the order of p table but we want priority order
801039ef:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039f2:	e8 09 2c 00 00       	call   80106600 <switchuvm>
      swtch(&(c->scheduler), p->context);
801039f7:	8b 43 9c             	mov    -0x64(%ebx),%eax
      p->state = RUNNING;
801039fa:	c7 43 8c 04 00 00 00 	movl   $0x4,-0x74(%ebx)
      swtch(&(c->scheduler), p->context);
80103a01:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a05:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103a08:	89 04 24             	mov    %eax,(%esp)
80103a0b:	e8 2b 0b 00 00       	call   8010453b <swtch>
      switchkvm();
...
80103a22:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){ //right now it goes in the order of p table but we want priority order
80103a25:	75 b4                	jne    801039db <scheduler+0x7b>
80103a27:	90                   	nop
    release(&ptable.lock);
80103a28:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a2f:	e8 7c 08 00 00       	call   801042b0 <release>
  }
80103a34:	e9 47 ff ff ff       	jmp    80103980 <scheduler+0x20>
80103a39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80103a40 <setpriority>:
{
...
80103a4a:	e8 51 fc ff ff       	call   801036a0 <myproc>
  if(p >= 0 && p<= 31){
80103a4f:	83 fb 1f             	cmp    $0x1f,%ebx
80103a52:	77 03                	ja     80103a57 <setpriority+0x17>
    curproc->priority = p;
80103a54:	89 58 7c             	mov    %ebx,0x7c(%eax)
}
80103a57:	83 c4 04             	add    $0x4,%esp
80103a5a:	5b                   	pop    %ebx
80103a5b:	5d                   	pop    %ebp
80103a5c:	c3                   	ret    
...
80103ace:	c7 04 24 10 72 10 80 	movl   $0x80107210,(%esp)
80103ad5:	e8 86 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103ada:	c7 04 24 3c 72 10 80 	movl   $0x8010723c,(%esp)
80103ae1:	e8 7a c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103ae6:	c7 04 24 2e 72 10 80 	movl   $0x8010722e,(%esp)
80103aed:	e8 6e c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103af2:	c7 04 24 22 72 10 80 	movl   $0x80107222,(%esp)
...
80103b07:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103b0a:	e8 91 fb ff ff       	call   801036a0 <myproc>
  if(curproc == initproc)
...
80103b3e:	75 e0                	jne    80103b20 <exit+0x20>
  begin_op();
80103b40:	e8 cb ef ff ff       	call   80102b10 <begin_op>
  iput(curproc->cwd);
80103b45:	8b 43 68             	mov    0x68(%ebx),%eax
80103b48:	89 04 24             	mov    %eax,(%esp)
80103b4b:	e8 80 dc ff ff       	call   801017d0 <iput>
  end_op();
80103b50:	e8 2b f0 ff ff       	call   80102b80 <end_op>
  curproc->cwd = 0;
80103b55:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103b5c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103b63:	e8 d8 06 00 00       	call   80104240 <acquire>
...
80103b8e:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103b95:	83 ea 80             	sub    $0xffffff80,%edx
80103b98:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
...
80103bac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bb0:	83 e9 80             	sub    $0xffffff80,%ecx
80103bb3:	81 f9 54 4d 11 80    	cmp    $0x80114d54,%ecx
...
80103bf6:	e8 65 fe ff ff       	call   80103a60 <sched>
  panic("zombie exit");
80103bfb:	c7 04 24 5d 72 10 80 	movl   $0x8010725d,(%esp)
80103c02:	e8 59 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103c07:	c7 04 24 50 72 10 80 	movl   $0x80107250,(%esp)
...
80103c2d:	e8 0e 06 00 00       	call   80104240 <acquire>
  myproc()->state = RUNNABLE;
80103c32:	e8 69 fa ff ff       	call   801036a0 <myproc>
...
80103c4a:	e8 61 06 00 00       	call   801042b0 <release>
}
80103c4f:	c9                   	leave  
80103c50:	c3                   	ret    
...
80103c6c:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
80103c6f:	e8 2c fa ff ff       	call   801036a0 <myproc>
  if(p == 0)
...
80103c91:	e8 aa 05 00 00       	call   80104240 <acquire>
    release(lk);
80103c96:	89 34 24             	mov    %esi,(%esp)
80103c99:	e8 12 06 00 00       	call   801042b0 <release>
  p->chan = chan;
...
80103cbb:	e8 f0 05 00 00       	call   801042b0 <release>
    acquire(lk);
...
80103cc9:	5d                   	pop    %ebp
    acquire(lk);
80103cca:	e9 71 05 00 00       	jmp    80104240 <acquire>
80103ccf:	90                   	nop
  p->chan = chan;
...
80103cee:	c7 04 24 6f 72 10 80 	movl   $0x8010726f,(%esp)
80103cf5:	e8 66 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103cfa:	c7 04 24 69 72 10 80 	movl   $0x80107269,(%esp)
...
80103d15:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103d18:	e8 83 f9 ff ff       	call   801036a0 <myproc>
  acquire(&ptable.lock);
80103d1d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103d24:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103d26:	e8 15 05 00 00       	call   80104240 <acquire>
    havekids = 0;
...
80103d38:	83 eb 80             	sub    $0xffffff80,%ebx
80103d3b:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
...
80103d4c:	74 2f                	je     80103d7d <wait+0x6d>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d4e:	83 eb 80             	sub    $0xffffff80,%ebx
      havekids = 1;
80103d51:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d56:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
...
80103d86:	e8 65 e5 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
...
80103d98:	e8 c3 2b 00 00       	call   80106960 <freevm>
        release(&ptable.lock);
...
80103dbd:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103dc4:	e8 e7 04 00 00       	call   801042b0 <release>
}
...
80103dd9:	e8 d2 04 00 00       	call   801042b0 <release>
}
...
80103e2f:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
...
80103e43:	5d                   	pop    %ebp
  release(&ptable.lock);
80103e44:	e9 67 04 00 00       	jmp    801042b0 <release>
...
80103e61:	e8 da 03 00 00       	call   80104240 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e93:	e8 18 04 00 00       	call   801042b0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103eb7:	e8 f4 03 00 00       	call   801042b0 <release>
}
...
80103ee4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103ee8:	c7 04 24 fb 75 10 80 	movl   $0x801075fb,(%esp)
80103eef:	e8 5c c7 ff ff       	call   80100650 <cprintf>
80103ef4:	83 eb 80             	sub    $0xffffff80,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ef7:	81 fb c0 4d 11 80    	cmp    $0x80114dc0,%ebx
...
80103f0a:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103f0d:	ba 80 72 10 80       	mov    $0x80107280,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103f12:	77 11                	ja     80103f25 <procdump+0x55>
80103f14:	8b 14 85 e0 72 10 80 	mov    -0x7fef8d20(,%eax,4),%edx
      state = "???";
80103f1b:	b8 80 72 10 80       	mov    $0x80107280,%eax
...
80103f30:	c7 04 24 84 72 10 80 	movl   $0x80107284,(%esp)
...
80103f5c:	e8 8f 01 00 00       	call   801040f0 <getcallerpcs>
...
80103f79:	c7 04 24 c1 6c 10 80 	movl   $0x80106cc1,(%esp)
...
80104259:	75 3a                	jne    80104295 <acquire+0x55>
  asm volatile("lock; xchgl %0, %1" :
...
8010426a:	75 f4                	jne    80104260 <acquire+0x20>
  __sync_synchronize();
8010426c:	0f ae f0             	mfence 
  lk->cpu = mycpu();
8010426f:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104272:	e8 89 f3 ff ff       	call   80103600 <mycpu>
80104277:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
8010427a:	8b 45 08             	mov    0x8(%ebp),%eax
8010427d:	83 c0 0c             	add    $0xc,%eax
80104280:	89 44 24 04          	mov    %eax,0x4(%esp)
80104284:	8d 45 08             	lea    0x8(%ebp),%eax
80104287:	89 04 24             	mov    %eax,(%esp)
8010428a:	e8 61 fe ff ff       	call   801040f0 <getcallerpcs>
}
...
80104294:	c3                   	ret    
    panic("acquire");
80104295:	c7 04 24 21 73 10 80 	movl   $0x80107321,(%esp)
8010429c:	e8 bf c0 ff ff       	call   80100360 <panic>
801042a1:	eb 0d                	jmp    801042b0 <release>
801042a3:	90                   	nop
801042a4:	90                   	nop
801042a5:	90                   	nop
801042a6:	90                   	nop
...
801042c4:	74 21                	je     801042e7 <release+0x37>
  lk->pcs[0] = 0;
...
801042dd:	83 c4 14             	add    $0x14,%esp
801042e0:	5b                   	pop    %ebx
801042e1:	5d                   	pop    %ebp
  popcli();
801042e2:	e9 a9 fe ff ff       	jmp    80104190 <popcli>
    panic("release");
801042e7:	c7 04 24 29 73 10 80 	movl   $0x80107329,(%esp)
801042ee:	e8 6d c0 ff ff       	call   80100360 <panic>
801042f3:	66 90                	xchg   %ax,%ax
...
80104413:	5d                   	pop    %ebp
  return memmove(dst, src, n);
80104414:	eb 8a                	jmp    801043a0 <memmove>
...
801046d8:	83 fa 15             	cmp    $0x15,%edx
...
80104890:	c7 44 24 04 d8 73 10 	movl   $0x801073d8,0x4(%esp)
80104897:	80 
...
801048ab:	c7 44 24 04 d7 73 10 	movl   $0x801073d7,0x4(%esp)
801048b2:	80 
...
801048c1:	79 89                	jns    8010484c <create+0xdc>
      panic("create dots");
801048c3:	c7 04 24 cb 73 10 80 	movl   $0x801073cb,(%esp)
801048ca:	e8 91 ba ff ff       	call   80100360 <panic>
    panic("create: dirlink");
801048cf:	c7 04 24 da 73 10 80 	movl   $0x801073da,(%esp)
801048d6:	e8 85 ba ff ff       	call   80100360 <panic>
    panic("create: ialloc");
801048db:	c7 04 24 bc 73 10 80 	movl   $0x801073bc,(%esp)
...
80104c81:	c7 44 24 04 d8 73 10 	movl   $0x801073d8,0x4(%esp)
80104c88:	80 
...
80104c99:	c7 44 24 04 d7 73 10 	movl   $0x801073d7,0x4(%esp)
80104ca0:	80 
...
80104ded:	c7 04 24 fc 73 10 80 	movl   $0x801073fc,(%esp)
80104df4:	e8 67 b5 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104df9:	c7 04 24 0e 74 10 80 	movl   $0x8010740e,(%esp)
80104e00:	e8 5b b5 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104e05:	c7 04 24 ea 73 10 80 	movl   $0x801073ea,(%esp)
...
80105284:	e8 67 f3 ff ff       	call   801045f0 <argint>
80105289:	85 c0                	test   %eax,%eax
8010528b:	78 13                	js     801052a0 <sys_setpriority+0x30>
    return -1;
  setpriority(priority);
8010528d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105290:	89 04 24             	mov    %eax,(%esp)
80105293:	e8 a8 e7 ff ff       	call   80103a40 <setpriority>
  return 0;
...
801052c3:	83 ec 08             	sub    $0x8,%esp
  exit();
801052c6:	e8 35 e8 ff ff       	call   80103b00 <exit>
...
801052d3:	5d                   	pop    %ebp
  return wait();
801052d4:	e9 37 ea ff ff       	jmp    80103d10 <wait>
...
801052f4:	e8 f7 f2 ff ff       	call   801045f0 <argint>
...
80105303:	e8 48 eb ff ff       	call   80103e50 <kill>
}
80105308:	c9                   	leave  
80105309:	c3                   	ret    
...
80105345:	e8 a6 f2 ff ff       	call   801045f0 <argint>
...
801053cf:	e8 8c e8 ff ff       	call   80103c60 <sleep>
  while(ticks - ticks0 < n){
...
801053f3:	e8 b8 ee ff ff       	call   801042b0 <release>
      return -1;
...
8010540f:	e8 9c ee ff ff       	call   801042b0 <release>
}
...
801054d9:	c7 44 24 04 1d 74 10 	movl   $0x8010741d,0x4(%esp)
801054e0:	80 
...
80105506:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010550c:	e8 bf eb ff ff       	call   801040d0 <initlock>
}
80105511:	c9                   	leave  
80105512:	c3                   	ret    
...
80105570:	ff 24 85 c4 74 10 80 	jmp    *-0x7fef8b3c(,%eax,4)
80105577:	90                   	nop
    lapiceoi();
    break;
...
801055e3:	c7 04 24 80 74 10 80 	movl   $0x80107480,(%esp)
...
8010566b:	75 a8                	jne    80105615 <trap+0xc5>
    exit();
8010566d:	e8 8e e4 ff ff       	call   80103b00 <exit>
...
80105680:	75 a9                	jne    8010562b <trap+0xdb>
    yield();
80105682:	e8 99 e5 ff ff       	call   80103c20 <yield>
...
801056dc:	c7 04 24 28 74 10 80 	movl   $0x80107428,(%esp)
...
80105721:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105724:	e8 97 ef ff ff       	call   801046c0 <syscall>
    if(myproc()->killed)
...
8010579a:	c7 04 24 4c 74 10 80 	movl   $0x8010744c,(%esp)
801057a1:	89 44 24 04          	mov    %eax,0x4(%esp)
801057a5:	e8 a6 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
801057aa:	c7 04 24 22 74 10 80 	movl   $0x80107422,(%esp)
...
801058a7:	00 
  for(p="xv6...\n"; *p; p++)
801058a8:	bb 44 75 10 80       	mov    $0x80107544,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801063d2:	e8 29 df ff ff       	call   80104300 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106471:	c3                   	ret    
      panic("remap");
80106472:	c7 04 24 4c 75 10 80 	movl   $0x8010754c,(%esp)
...
801064c3:	e8 28 be ff ff       	call   801022f0 <kfree>
      *pte = 0;
...
80106523:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106526:	e8 55 d1 ff ff       	call   80103680 <cpuid>
...
80106624:	0f 84 c3 00 00 00    	je     801066ed <switchuvm+0xed>
  pushcli();
8010662a:	e8 21 db ff ff       	call   80104150 <pushcli>
...
801066db:	5d                   	pop    %ebp
  popcli();
801066dc:	e9 af da ff ff       	jmp    80104190 <popcli>
    panic("switchuvm: no process");
801066e1:	c7 04 24 52 75 10 80 	movl   $0x80107552,(%esp)
801066e8:	e8 73 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801066ed:	c7 04 24 7d 75 10 80 	movl   $0x8010757d,(%esp)
801066f4:	e8 67 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
801066f9:	c7 04 24 68 75 10 80 	movl   $0x80107568,(%esp)
...
80106747:	e8 b4 db ff ff       	call   80104300 <memset>
...
8010677b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
8010677c:	e9 1f dc ff ff       	jmp    801043a0 <memmove>
    panic("inituvm: more than a page");
80106781:	c7 04 24 91 75 10 80 	movl   $0x80107591,(%esp)
...
8010680d:	e8 4e b1 ff ff       	call   80101960 <readi>
...
80106832:	c7 04 24 ab 75 10 80 	movl   $0x801075ab,(%esp)
80106839:	e8 22 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010683e:	c7 04 24 4c 76 10 80 	movl   $0x8010764c,(%esp)
...
80106893:	e8 68 da ff ff       	call   80104300 <memset>
...
801068c4:	76 2a                	jbe    801068f0 <allocuvm+0xa0>
    mem = kalloc();
801068c6:	e8 d5 bb ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
...
801068d1:	c7 04 24 c9 75 10 80 	movl   $0x801075c9,(%esp)
...
80106900:	c7 04 24 e1 75 10 80 	movl   $0x801075e1,(%esp)
...
801069c3:	e9 28 b9 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
801069c8:	c7 04 24 fd 75 10 80 	movl   $0x801075fd,(%esp)
...
80106a0b:	e8 f0 d8 ff ff       	call   80104300 <memset>
...
80106aab:	c3                   	ret    
    panic("clearpteu");
80106aac:	c7 04 24 0e 76 10 80 	movl   $0x8010760e,(%esp)
...
80106ad3:	0f 84 b9 00 00 00    	je     80106b92 <copyuvm+0xd2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106ad9:	8b 45 0c             	mov    0xc(%ebp),%eax
80106adc:	85 c0                	test   %eax,%eax
80106ade:	0f 84 94 00 00 00    	je     80106b78 <copyuvm+0xb8>
80106ae4:	31 ff                	xor    %edi,%edi
...
80106ae8:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106aee:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106af5:	00 
80106af6:	89 74 24 04          	mov    %esi,0x4(%esp)
80106afa:	89 04 24             	mov    %eax,(%esp)
80106afd:	e8 9e d8 ff ff       	call   801043a0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106b02:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b05:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106b0a:	89 fa                	mov    %edi,%edx
80106b0c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b10:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106b16:	89 04 24             	mov    %eax,(%esp)
80106b19:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106b1c:	e8 df f8 ff ff       	call   80106400 <mappages>
80106b21:	85 c0                	test   %eax,%eax
80106b23:	78 63                	js     80106b88 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106b25:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106b2b:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80106b2e:	76 48                	jbe    80106b78 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106b30:	8b 45 08             	mov    0x8(%ebp),%eax
80106b33:	31 c9                	xor    %ecx,%ecx
80106b35:	89 fa                	mov    %edi,%edx
80106b37:	e8 34 f8 ff ff       	call   80106370 <walkpgdir>
80106b3c:	85 c0                	test   %eax,%eax
80106b3e:	74 62                	je     80106ba2 <copyuvm+0xe2>
    if(!(*pte & PTE_P))
80106b40:	8b 00                	mov    (%eax),%eax
80106b42:	a8 01                	test   $0x1,%al
80106b44:	74 50                	je     80106b96 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80106b46:	89 c6                	mov    %eax,%esi
    flags = PTE_FLAGS(*pte);
80106b48:	25 ff 0f 00 00       	and    $0xfff,%eax
80106b4d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106b50:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106b56:	e8 45 b9 ff ff       	call   801024a0 <kalloc>
80106b5b:	85 c0                	test   %eax,%eax
80106b5d:	89 c3                	mov    %eax,%ebx
80106b5f:	75 87                	jne    80106ae8 <copyuvm+0x28>
    }
  }
  return d;
...
bad:
  freevm(d);
80106b61:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106b64:	89 04 24             	mov    %eax,(%esp)
80106b67:	e8 f4 fd ff ff       	call   80106960 <freevm>
  return 0;
80106b6c:	31 c0                	xor    %eax,%eax
}
80106b6e:	83 c4 2c             	add    $0x2c,%esp
80106b71:	5b                   	pop    %ebx
80106b72:	5e                   	pop    %esi
80106b73:	5f                   	pop    %edi
80106b74:	5d                   	pop    %ebp
...
80106b78:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106b7b:	83 c4 2c             	add    $0x2c,%esp
80106b7e:	5b                   	pop    %ebx
80106b7f:	5e                   	pop    %esi
80106b80:	5f                   	pop    %edi
80106b81:	5d                   	pop    %ebp
...
80106b84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      kfree(mem);
80106b88:	89 1c 24             	mov    %ebx,(%esp)
80106b8b:	e8 60 b7 ff ff       	call   801022f0 <kfree>
      goto bad;
80106b90:	eb cf                	jmp    80106b61 <copyuvm+0xa1>
    return 0;
80106b92:	31 c0                	xor    %eax,%eax
80106b94:	eb d8                	jmp    80106b6e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106b96:	c7 04 24 32 76 10 80 	movl   $0x80107632,(%esp)
80106b9d:	e8 be 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106ba2:	c7 04 24 18 76 10 80 	movl   $0x80107618,(%esp)
...
80106c2c:	e8 6f d7 ff ff       	call   801043a0 <memmove>
    len -= n;
    buf += n;
